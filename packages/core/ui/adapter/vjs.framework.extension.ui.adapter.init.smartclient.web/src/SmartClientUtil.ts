define('./SmartClientUtil', function (require, exports, module) {
  var ScopeManager,
    ScopeTask,
    TaskManager,
    ComponentData,
  ...
  export function initModule(sb) {
    ...
    ScopeTask = sb.getService(
      'vjs.framework.extension.platform.global.task.ScopeTask'
    )
    TaskManager = sb.getService(
      'vjs.framework.extension.platform.global.task.TaskManager'
    )
    ComponentData = sb.getService(
      'vjs.framework.extension.platform.global.data.ComponentData'
    )
    AppData = sb.getService(
      'vjs.framework.extension.platform.global.data.AppData'
    )
    ...
    uuidUtil = sb.getService('vjs.framework.extension.util.UUID')
    widgetRenderer = sb.getService(
      'vjs.framework.extension.platform.services.view.widget.common.action.WidgetRenderer'
    )
    processorManager = sb.getService(
      'vjs.framework.extension.platform.services.view.window.property.ProcessorManager'
    )
  }
