...
!(function (a, b) {
  ...
  let s = (function (a) {
    ...
    function qb(a) {
      for (let b = 0, c = a.length, d = ''; c > b; b++) d += a[b].value
      return d
    }
    function rb(a, b, c) {
      let d = b.dir,
    ...
    function ub(a, b, c, d, e) {
      for (let f, g = [], h = 0, i = a.length, j = null != b; i > h; h++)
  ...
  let t = m.expr.match.needsContext,
    u = /^<(\w+)\s*\/?>(?:<\/\1>|)$/,
    v = /^.[^:#\[\.,]*$/
  function w(a, b, c) {
    if (m.isFunction(b))
  ...
  function O(a, b, c) {
    if (void 0 === c && 1 === a.nodeType) {
      let d = 'data-' + b.replace(N, '-$1').toLowerCase()
  ...
  function yb(a) {
    let b = pb.exec(a.type)
    return b ? (a.type = b[1]) : a.removeAttribute('type'), a
  }
  function zb(a, b) {
    for (let c, d = 0; null != (c = a[d]); d++)
  ...
  function Vb(a, b) {
    for (let c, d, e, f = [], g = 0, h = a.length; h > g; g++)
      (d = a[g]),
        d.style &&
  ...
  function Xb(a, b, c, d, e) {
    for (
      let f = c === (d ? 'border' : 'content') ? 4 : 'width' === b ? 1 : 0,
        g = 0;
      4 > f;
      f += 2
    )
  ...
  function hc(a, b, c) {
    for (
      let d, e = (ec[b] || []).concat(ec['*']), f = 0, g = e.length;
      g > f;
      f++
    )
  ...
  let sc = /^(?:input|select|textarea|button|object)$/i,
    tc = /^(?:a|area)$/i
  m.fn.extend({
    prop: function (a, b) {
  ...
  let cd = a.document.documentElement
  function dd(a) {
    return m.isWindow(a)
      ? a
      : 9 === a.nodeType
