  ...
  return (function (t) {
    ...
    '+pML': function (t, e, i) {
      ...
      var n = function () {
          ...
          return i(
            'div',
            {
              staticClass: 'vui-m-map-progressbar',
              attrs: { widgetCode: t.widgetCode }
            },
            [
              i('div', { staticClass: 'vui-m-map-btn-container' }, [
                t.isStart
                  ? i(
                      'div',
                      {
                        staticClass: 'vui-m-map-progressbar-btn',
                        on: { click: t.pauseEvent }
                      },
                      [i('i', { staticClass: 'fal fa-pause-circle' })]
                    )
                  : i(
                      'div',
                      {
                      ...
                      [i('i', { staticClass: 'fal fa-play-circle' })]
                    ),
                t._v(' '),
                i(
                  'div',
                  {
                    staticClass: 'vui-m-map-progressbar-btn btn-reset',
                    on: { click: t.resetEvent }
                  },
                  [i('i', { staticClass: 'fal fa-redo-alt' })]
                ),
                t._v(' '),
                i(
                  'div',
                      ...
                      [
                        i(
                          'ul',
                          {
                            ...
                            staticClass: 'vui-m-map-chose-speed-box'
                          },
              ...
              i(
                ...
                {
                  ref: 'progressBar',
                  staticClass: 'vui-m-map-progressbar-container',
                  on: {
                ...
                [
                  i('div', { staticClass: 'vui-m-map-progressbar-inner' }, [
                    i('div', {
                      ref: 'progress',
                      staticClass: 'vui-m-map-progress-now'
                    }),
                    t._v(' '),
                    i(
                      'div',
                      {
                        ...
                        staticClass: 'vui-m-map-progress-btn-wrapper',
                        on: {
                          touchstart: t.onTouchStart,
                          mousedown: t.onMouseDown
                        }
                      },
                      [i('div', { staticClass: 'vui-m-map-progress-btn' })]
                    )
                  ])
                ]
              )
    ...
    'JkW7': function (t, e, i) {
      ...
      I.default.component(s.default.name, s.default),
        I.default.component(r.default.name, r.default),
        ...
        (e.default = {
          vuiMMap: s.default,
          vuiMMapSearch: u.default,
          vuiMMapRoute: p.default,
          vuiMMapMarker: r.default,
          vuiMMapPolyline: f.default,
          vuiMMapInfoWindow: h.default,
          vuiMMapPlayback: v.default
        })
    },
    'LeuP': function (t, e, i) {
      'use strict'
    ...
    'VnJF': function (t, e, i) {
      ...
      e.default = {
        ...
        props: {
          ...
          strokeStyle: { type: String },
          massClear: { type: Boolean, default: !1 },
          ...
          mulModelLoadLine: function (t) {
            ...
            if (O.length > 0)
              ...
              if (this.startIcon && p.length > 0) {
                var w = { lat: p[0][M], lng: p[0][S] }
                this.startIconInstances.push(
                  this.loadIcon(w, this.startIconObj)
                )
              }
              if (this.endIcon && p.length > 0) {
                var w = { lat: p[p.length - 1][M], lng: p[p.length - 1][S] }
                this.endIconInstances.push(this.loadIcon(w, this.endIconObj))
              }
            }
          }
        },
      ...
      e.default = {
        ...
        methods: {
          ...
          _getProgressBarWidth: function () {
            return this.$refs.progressBar.clientWidth - 160 - 8
          },
          ...
          computed: {
            ...
            localIcon: function () {
              return this.localIconSrc &&
                ...
                : {
                    url: 'https://api.map.baidu.com/images/geolocation-control/point/position-icon-14x14.png',
                    size: { width: 14, height: 14 },
                    opts: { imageSize: { width: 14, height: 14 } }
                  }
            }
          },
          methods: {
              ...
              if (
                ...
                I.forEach(function (t) {
                  ...
                  this.geolocationInstance.addEventListener(
                    ...
                    function (i) {
                      e.clearOverlays()
                      var n = new BMap.Point(i.point.lng, i.point.lat),
                        o = new BMap.Marker(n, {
                          icon: v && (0, s.createIcon)(BMap, v)
                        })
                      e.addOverlay(o),
                        e.panTo(n),
                        t.$emit('on-locationSuccess', i)
                    }
                  ),
                  this.geolocationInstance.addEventListener(
                    'locationError',
