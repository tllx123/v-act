if (!window.Vue) {
  !(function (t, e) {
    ...
    function f(t, e) {
      for (
        let n = Object.create(null), r = t.split(','), i = 0;
        i < r.length;
        i++
      )
        n[r[i]] = !0
    ...
    function m(t, e) {
      e = e || 0
      for (let n = t.length - e, r = new Array(n); n--; ) r[n] = t[n + e]
      return r
    }
    function y(t, e) {
    ...
    function g(t) {
      for (let e = {}, n = 0; n < t.length; n++) t[n] && y(e, t[n])
      return e
    }
    function _(t, e, n) {}
    function b(t, e) {
    ...
    function $(t, e) {
      for (let n = 0; n < t.length; n++) if (b(t[n], e)) return n
      return -1
    }
    function C(t) {
      let e = !1
    ...
    function P(t, e) {
      if (!e) return t
      for (let n, r, i, o = Object.keys(e), s = 0; s < o.length; s++)
        (r = t[(n = o[s])]),
          (i = e[n]),
    ...
    function G(t, e) {
      ...
      for (let n = 0, r = e.length; n < r; n++) if (W(e[n]) === W(t)) return !0
      return !1
    }
    function Z(t) {
    ...
    function Q(t) {
      for (let e = t.length, n = new Array(e), r = 0; r < e; r++) n[r] = Y(t[r])
      return n
    }
    function X(t) {
      function e() {
    ...
    function $t(t, e, n, r, i) {
      ...
      if (
        ...
        eo.shouldConvert = !1
        for (
          let a = t._props, s = t.$options._propKeys || [], c = 0;
          c < s.length;
          c++
        ) {
          let u = s[c]
      ...
      if (n) {
        let l = t.$options._parentListeners
    ...
    function wt(t, e) {
      ...
      if (t._inactive || null === t._inactive) {
        t._inactive = !1
        for (let n = 0; n < t.$children.length; n++) wt(t.$children[n])
        At(t, 'activated')
      }
    }
    function xt(t, e) {
      if (!((e && ((t._directInactive = !0), Ct(t))) || t._inactive)) {
        t._inactive = !0
        for (let n = 0; n < t.$children.length; n++) xt(t.$children[n])
        At(t, 'deactivated')
      }
    }
    function At(t, e) {
    ...
    function Et(t) {
      for (let e = 0; e < t.length; e++) (t[e]._inactive = !0), wt(t[e], !0)
    }
    function jt(t) {
      let e = t.id
      if (null == vo[e]) {
        if (((vo[e] = !0), mo)) {
          for (let n = fo.length - 1; n > yo && fo[n].id > t.id; ) n--
          fo.splice(n + 1, 0, t)
        } else fo.push(t)
        ho || ((ho = !0), Wi(Ot))
      }
    ...
    function Ut(t, e) {
      t.$options.props
      for (let n in e) t[n] = null == e[n] ? _ : h(e[n], t)
    }
    function Vt(t, e) {
      for (let n in e) {
        let r = e[n]
    ...
    function te(t, n) {
      let r = (t.model && t.model.prop) || 'value',
    ...
    function ve(t) {
      ...
      let e = (t.$vnode = t.$options._parentVnode),
        n = e && e.context
    ...
    function we(t) {
      ...
      for (let n in e) It(t.prototype, '_props', n)
    }
    function xe(t) {
      let e = t.options.computed
      for (let n in e) Ht(t.prototype, n, e[n])
    }
    function Ae(t) {
    ...
    function Ee(t) {
      for (let n = t.data, r = t, i = t; e(i.componentInstance); )
    ...
    function Me(t) {
      for (let n, r = '', i = 0, o = t.length; i < o; i++)
    ...
    function ze(t, e) {
      ...
      if (u.length) {
        let f = function () {
          for (let n = 0; n < u.length; n++) qe(u[n], 'inserted', e, t)
        }
    ...
    function En(t, e) {
      ...
      ;(n = Sn(t.data)) && y(r, n)
      for (let o = t; (o = o.parent); ) o.data && (n = Sn(o.data)) && y(r, n)
      return r
    }
    function jn(n, r) {
      let i = r.data,
    ...
    function Un(n, r) {
      ...
      if (!t(a) && !e(i._enterCb) && 1 === i.nodeType) {
        ...
        let S = !k._isMounted || !n.isRootInsert
        if (!S || $ || '' === $) {
          let T = S && d ? d : u,
            E = S && h ? h : p,
            j = S && v ? v : f,
    ...
    function Vn(n, r) {
      function i() {
        x.cancelled ||
          (n.data.show ||
            ((a.parentNode._pending || (a.parentNode._pending = {}))[n.key] =
              n),
          v && v(a),
          b &&
            (Dn(a, f),
    ...
    function qn(t, e, n) {
      ...
      if (!i || Array.isArray(r)) {
        for (let o, a, s = 0, c = t.options.length; s < c; s++)
          if (((a = t.options[s]), i))
    ...
    function Wn(t, e) {
      for (let n = 0, r = e.length; n < r; n++) if (b(Gn(e[n]), t)) return !1
      return !0
    }
    function Gn(t) {
    ...
    function er(t) {
      let e = {},
        n = t.$options
      for (let r in n.propsData) e[r] = t[r]
      let i = n._parentListeners
      for (let o in i) e[gi(o)] = i[o]
      return e
    }
    function nr(t, e) {
    ...
    function ur(t, e) {
      let n = e ? Ba(e) : Ra
      if (n.test(t)) {
        for (let r, i, o = [], a = (n.lastIndex = 0); (r = n.exec(t)); ) {
    ...
    function fr(t, e) {
      ...
      function r(t, n, r) {
        ...
        if (i >= 0) {
          for (let c = a.length - 1; c >= i; c--) e.end && e.end(a[c].tag, n, r)
        ...
        if (((i = t), o && gs(o))) {
          ...
          if (0 === h) {
            ...
            let $ = (function () {
              let e = t.match(es)
              if (e) {
                let r = { tagName: e[1], attrs: [], start: l }
                n(e[0].length)
                for (let i, o; !(i = t.match(ns)) && (o = t.match(Qa)); )
    ...
    function Fr(t, e) {
      ...
      let n = Ps.test(e.value),
        r = Ds.test(e.value)
      if (e.modifiers) {
        let i = '',
          o = '',
          a = []
        for (let s in e.modifiers)
    ...
    function ti(t, e, n, r, i) {
      ...
      if (o.length) {
        ...
        if (1 === o.length && a.for && 'template' !== a.tag && 'slot' !== a.tag)
          return (r || Ur)(a, e)
        let s = n ? ei(o, e.maybeComponent) : 0,
          c = i || ri
        return (
          '[' +
          o
    ...
    function si(t, e, n) {
      let r = e.inlineTemplate ? null : ti(e, n, !0)
    ...
    function fi(t) {
      ...
      return function (n, r, i) {
        let o = (r = r || {}).delimiters ? String(r.delimiters) + n : n
        if (e[o]) return e[o]
        let a = t(n, r),
          s = {},
          c = []
    ...
    let di = Object.prototype.toString,
    ...
    let to = Object.getOwnPropertyNames(Xi),
      eo = { shouldConvert: !0 },
      no = function (t) {
        ;(this.value = t),
          (this.dep = new Zi()),
    ...
    let ro = Oi.optionMergeStrategies
    ...
    let Sa =
      ...
      Ea = (function (r) {
        ...
        function u(t, r, i, o) {
          let a = t.data
          if (e(a)) {
            let s = e(t.componentInstance) && a.keepAlive
            if (
        ...
        function p(t, n, r, i) {
          for (let o, a = t; a.componentInstance; )
            if (
        ...
        function m(t, n) {
          for (let r = 0; r < S.create.length; ++r) S.create[r](ea, t)
          e((k = t.data.hook)) &&
        ...
        let j = f('attrs,style,class,staticClass,staticStyle,key')
            ...
            if (t(r)) (f = !0), c(i, p, u, l)
              ...
              if (!d && He(r, i)) w(r, i, p, s)
                ...
                if (
                  ...
                  for (let y = i.parent; y; ) (y.elm = i.elm), (y = y.parent)
                  if (h(i))
  ...
  Vue.directive('res', function (el, binding, node) {
    ...
    let path = 'itop/resources/' + componentCode + '_' + binding.value
