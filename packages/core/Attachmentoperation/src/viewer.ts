    ...
    var PDFPresentationMode = (function PDFPresentationModeClosure() {
      ...
      PDFPresentationMode.prototype = {
        ...
        _setSwitchInProgress:
          function PDFPresentationMode_setSwitchInProgress() {
      ...
      PDFSidebar.prototype = {
        ...
        switchView: function PDFSidebar_switchView(view, forceOpen) {
          ...
          switch (view) {
            ...
            default:
              console.error(
                'PDFSidebar_switchView: "' + view + '" is an unsupported value.'
              )
              return
          }
        ...
        _addEventListeners: function PDFSidebar_addEventListeners() {
          ...
          self.attachmentsView.addEventListener(
            'attachmentsloaded',
            function (evt) {
...
*/
      ...
      PDFPageView.prototype = {
        ...
        cssTransform: function PDFPageView_transform(
          ...
          var relativeRotation =
            this.viewport.rotation - canvas._viewport.rotation
    ...
    var PDFThumbnailView = (function PDFThumbnailViewClosure() {
      ...
      PDFThumbnailView.prototype = {
        ...
        _convertCanvasToImage:
          function PDFThumbnailView_convertCanvasToImage() {
            if (!this.canvas) {
              return
            }
  ...
  ;(function (root, factory) {
    ...
    var SecondaryToolbar = {
      ...
      presentationModeClick: function secondaryToolbarPresentationModeClick(
        evt
      ) {
      ...
      documentPropertiesClick: function secondaryToolbarDocumentPropsClick(
        evt
      ) {
  ...
  ;(function (root, factory) {
    ...
    this,
    function (exports, uiUtils, grabToPan, preferences, secondaryToolbar) {
      var mozL10n = uiUtils.mozL10n
        ...
        function HandTool(options) {
          ...
          this.handTool = new GrabToPan({
            ...
            onActiveChanged: function (isActive) {
              ...
              if (isActive) {
                this.toggleHandTool.title = mozL10n.get(
                  'hand_tool_disable.title',
                  null,
                  'Disable hand tool'
                )
                this.toggleHandTool.firstElementChild.textContent = mozL10n.get(
  ...
  ;(function (root, factory) {
    ...
    function (
      ...
      var DownloadManager =
        downloadManagerLib.DownloadManager || firefoxComLib.DownloadManager
      ...
      var PDFViewerApplication = {
        ...
        load: function pdfViewLoad(pdfDocument, scale) {
          ...
          toolbarConfig.numPages.textContent = mozL10n.get(
            'page_of',
        ...
        setInitialView: function pdfViewSetInitialView(storedHash, options) {
          ...
          this.appConfig.toolbar.pageNumber.value =
            this.pdfViewer.currentPageNumber

          this.pdfSidebar.setInitialView(
            this.preferenceSidebarViewOnLoad || sidebarView | 0
          )
      ...
      function webViewerInitialized() {
        ...
        appConfig.toolbar.presentationModeButton.addEventListener(
          'click',
          SecondaryToolbar.presentationModeClick.bind(SecondaryToolbar)
        )

        appConfig.toolbar.openFile.addEventListener(
          'click',
          SecondaryToolbar.openFileClick.bind(SecondaryToolbar)
        )

        appConfig.toolbar.print.addEventListener(
          'click',
          SecondaryToolbar.printClick.bind(SecondaryToolbar)
        )

        appConfig.toolbar.download.addEventListener(
          'click',
      ...
      document.addEventListener(
        ...
        function (e) {
          ...
          if (pageNumber === PDFViewerApplication.page) {
            var pageNumberInput =
              PDFViewerApplication.appConfig.toolbar.pageNumber
      ...
      document.addEventListener(
        ...
        function (evt) {
          ...
          PDFViewerApplication.pdfSidebar.switchView(
            view,
            /* forceOpen = */ true
          )
        },
      ...
      window.addEventListener(
        ...
        function (evt) {
          ...
          PDFViewerApplication.appConfig.secondaryToolbar.viewBookmark.href =
            href
      ...
      window.addEventListener('resize', function webViewerResize(evt) {
        ...
        SecondaryToolbar.setMaxHeight(
          PDFViewerApplication.appConfig.mainContainer
        )
      })
      ...
      window.addEventListener(
        ...
        function localized(evt) {
          ...
          PDFViewerApplication.animationStartedPromise.then(function () {
            ...
            var container =
              PDFViewerApplication.appConfig.toolbar.scaleSelectContainer
      ...
      window.addEventListener(
        ...
        function pagechange(evt) {
          ...
          PDFViewerApplication.appConfig.toolbar.next.disabled =
            page >= numPages

          PDFViewerApplication.appConfig.toolbar.firstPage.disabled = page <= 1
          PDFViewerApplication.appConfig.toolbar.lastPage.disabled =
            page >= numPages
