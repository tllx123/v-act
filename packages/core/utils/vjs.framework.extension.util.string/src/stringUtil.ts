const anchor = function (str, anchorname) {
  return str.anchor(anchorname)
}

const big = function (str) {
  return str.big()
}
 ...
 */
let charCodeAt = function (str, index) {
 ...
 * 按照指定的颜色来显示字符串
 */
let fontcolor = function (str, color) {
 ...
 * 按照指定的尺寸来显示字符串
 */
let fontsize = function (str, size) {
 ...
 */
let indexOf = function (str, searchvalue, fromindex) {
 ...
 */
let lastIndexOf = function (str, searchvalue, fromindex) {
 ...
 * 用本地特定的顺序来比较两个字符串。
 */
let localeCompare = function (str, target) {
 ...
 */
let match = function (str, searchvalue) {
 ...
 */
let replace = function (str, substr, replacement) {
 ...
 */
let search = function (str, regexp) {
 ...
 */
let split = function (str, separator, howmany) {
 ...
 */
let substring = function (str, start, stop) {
 ...
 * 把字符串转换为小写
 */
let toLocaleLowerCase = function (str) {
 ...
 * 把字符串转换为大写
 */
let toLocaleUpperCase = function (str) {
...
let isInArray = function (str, strArray) {
...
let startsWith = function (prefix, str) {
  if (
    prefix == null ||
    prefix == '' ||
    str.length == 0 ||
...
let endsWith = function (sufix, str) {
  if (
    sufix == null ||
    sufix == '' ||
    str.length == 0 ||
 ...
 */
let replaceByIndex = function (origStr, replaceStr, beginIndex, endIndex) {
