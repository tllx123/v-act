    ...
    var y = (function () {
        function h() {
          ...
          if (t != this.DEFAULT_DIGITS) {
            if (t < this.MIN_DIGITS)
              throw 'MathContext(): Digits too small: ' + t
            if (t > this.MAX_DIGITS)
              throw 'MathContext(): Digits too large: ' + t
          }
      ...
      L = (function (h) {
        ...
        function I() {
          ...
          if (2 == I.arguments.length) a = I.arguments[1]
            ...
            throw (
              'setScale(): ' + I.arguments.length + ' given; expected 1 or 2'
            )
          var b = I.arguments[0],
            c,
            d
        ...
        function x() {
          ...
          if (2 == x.arguments.length)
            (a = x.arguments[0]), (b = x.arguments[1])
        ...
        f.prototype.dodivide = function (a, b, c, d) {
          ...
          if (0 <= d)
            return (
              ...
              k.exp != -d &&
                ((k.mant = this.extend(k.mant, k.mant.length + 1)),
                (k.exp -= 1)),
              k.finish(c, !0)
            )
