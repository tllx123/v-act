        ...
        function (require, module, exports) {
          ...
          module.exports = function (environment) {
            ...
            ImportManager.prototype.push = function (
              ...
              //modify by xiedh add a new parameter options
            ...
            return {
              ...
              parse: function (str, callback, additionalData) {
                ...
                if (context.processImports !== false) {
                  //modify by xiedh;add a new parameter additionalData
              ...
              if (!callback) {
                ...
                this.parse(
                  ...
                  function (err, root, imports, options) {
                    ...
                    //modify by xiedh add an paramerter root
      ...
      92: [
        function (require, module, exports) {
          ...
          var ImportVisitor = function (importer, finish, options) {
            //modify by xiedh,add new parameter options
            //modify by xiedh add a new attribute options
            this.options = options
            this._visitor = new Visitor(this)
            ...
            processImportNode: function (importNode, context, importParent) {
              ...
              if (evaldImportNode && (!evaldImportNode.css || inlineCSS)) {
                ...
                this._importer.push(
                  ...
                  sequencedOnImported,
                  this.options
                ) //modify by xiedh add a new parameter this.options
              } else {
                this.importCount--
                if (this.isFinished) {
                  this._sequencer.tryRun()
