  ...
  return (function () {
  ...
  })()(
    {
      1: [
        function (require, module, exports) {
          ...
          module.exports = function (window, options) {
            ...
            options.poll = options.poll || (options.isFileProtocol ? 1e3 : 1500)
            options.env =
              options.env ||
      ...
      2: [
        function (require, module, exports) {
          ...
          function resolveOrReject(data) {
            if (data.filename) console.warn(data)
            if (!options.async) head.removeChild(style)
          }
          if (options.onReady) {
            if (/!watch/.test(window.location.hash)) less.watch()
            if (!options.async) {
        ...
        function (require, module, exports) {
          ...
          module.exports = {
            createCSS: function (document, styles, sheet) {
              ...
              if (sheet.media) styleNode.setAttribute('media', sheet.media)
              styleNode.id = id
              ...
              if (oldStyleNode === null || keepOldStyleNode === false) {
                ...
                if (nextEl) nextEl.parentNode.insertBefore(styleNode, nextEl)
        ...
        function (require, module, exports) {
          ...
          module.exports = function (window, less, options) {
            function errorHTML(e, rootHref) {
              ...
              var template =
                '\x3cli\x3e\x3clabel\x3e{line}\x3c/label\x3e\x3cpre class\x3d"{class}"\x3e{content}\x3c/pre\x3e\x3c/li\x3e'
              ...
              if (e.stack && (e.extract || options.logLevel >= 4))
                content +=
                  '\x3cbr/\x3eStack Trace\x3c/br /\x3e' +
            ...
            return { add: error, remove: removeError }
          }
        },
        { './browser': 3, './utils': 11 }
      ],
          ...
          module.exports = function (options, logger) {
            ...
            FileManager.prototype.doXHR = function doXHR(
              ...
              xhr.setRequestHeader(
                'Accept',
                type || 'text/x-less, text/css; q\x3d0.9, */*; q\x3d0.5'
              )
              xhr.send(null)
              ...
              else handleResponse(xhr, callback, errback)
            }
        ...
        function (require, module, exports) {
          ...
          module.exports = function (window, options) {
            ...
            var cache = (less.cache =
              options.cache || require('./cache')(window, options, less.logger))
            ...
            function loadStyleSheet(
              ...
              if (modifyVars) instanceOptions.modifyVars = modifyVars
                ...
                less.watchTimer = setInterval(function () {
                  if (less.watchMode) {
                    ...
                    loadStyleSheets(function (e, css, _, sheet, webInfo) {
                      if (e) errors.add(e, e.href || sheet.href)
                      else if (css)
          ...
          module.exports = function (less, options) {
            ...
            if (!options.loggers)
              options.loggers = [
                {
                  debug: function (msg) {
                    if (options.logLevel >= logLevel_debug) console.log(msg)
                  },
                  info: function (msg) {
                    if (options.logLevel >= logLevel_info) console.log(msg)
                  },
                  warn: function (msg) {
                    if (options.logLevel >= logLevel_warn) console.warn(msg)
                  },
                  error: function (msg) {
                    if (options.logLevel >= logLevel_error) console.error(msg)
                  }
                }
              ]
      ...
      13: [
        function (require, module, exports) {
          ...
          contexts.Eval.prototype.enterCalc = function () {
            if (!this.calcStack) this.calcStack = []
            this.calcStack.push(true)
            this.inCalc = true
          }
          contexts.Eval.prototype.exitCalc = function () {
            this.calcStack.pop()
            if (!this.calcStack) this.inCalc = false
          }
          contexts.Eval.prototype.inParenthesis = function () {
            if (!this.parensStack) this.parensStack = []
          ...
          abstractFileManager.prototype.extractUrlParts =
            function extractUrlParts(url, baseUrl) {
              ...
              if (baseUrl && (!urlParts[1] || urlParts[2])) {
                ...
                if (!urlParts[2]) urlParts[3] = baseUrlParts[3] + urlParts[3]
              }
              if (urlParts[3]) {
                rawDirectories = urlParts[3].replace(/\\/g, '/').split('/')
                for (i = 0; i < rawDirectories.length; i++)
                  if (rawDirectories[i] === '..') directories.pop()
      ...
      19: [
        function (require, module, exports) {
          ...
          AbstractPluginLoader.prototype.evalPlugin = function (
            ...
            if (fileInfo)
              if (typeof fileInfo === 'string') filename = fileInfo
            ...
            if (filename) {
              ...
              if (pluginObj) {
                ...
                try {
                  if (pluginObj.use) pluginObj.use.call(this.context, pluginObj)
                } catch (e) {
            ...
            if (pluginObj instanceof LessError) return pluginObj
            if (pluginObj) {
          ...
          AbstractPluginLoader.prototype.printUsage = function (plugins) {
            for (var i = 0; i < plugins.length; i++) {
              ...
              if (plugin.printUsage) plugin.printUsage()
            }
          }
        ...
        function (require, module, exports) {
          ...
          function colorBlend(mode, color1, color2) {
            ...
            for (var i = 0; i < 3; i++) {
              ...
              cs = color2.rgb[i] / 255
              cr = mode(cb, cs)
              if (ar) cr = (as * cs + ab * (cb - as * (cb + cs - cr))) / ar
              r[i] = cr * 255
            }
            ...
            functionRegistry.add(
              ...
              function (mimetypeNode, filePathNode) {
                ...
                if (!mimetypeNode) {
                  ...
                  if (mimetype === 'image/svg+xml') useBase64 = false
                  else {
          ...
          var defaultFunc = {
            eval: function () {
              var v = this.value_,
                e = this.error_
              if (e) throw e
              if (v != null) return v ? Keyword.True : Keyword.False
            },
            value: function (v) {
              this.value_ = v
            },
          ...
          functionRegistry.addMultiple({
            ...
            each: function (list, rs) {
              var rules = [],
                ...
                iterator
              if (list.value)
                if (Array.isArray(list.value)) iterator = list.value
                else iterator = [list.value]
              else if (list.ruleset) iterator = list.ruleset.rules
              else if (list.rules) iterator = list.rules
              else if (Array.isArray(list)) iterator = list
              else iterator = [list]
              var valueName = '@value',
                keyName = '@key',
                indexName = '@index'
          ...
          module.exports = function (environment) {
            ...
            functionRegistry.add('svg-gradient', function (direction) {
              var stops,
                ...
                gradientType = 'linear',
                rectangleDimension =
                  'x\x3d"0" y\x3d"0" width\x3d"1" height\x3d"1"',
              ...
              if (arguments.length == 2) {
                if (arguments[1].value.length < 2) throwArgumentDescriptor()
              ...
              switch (directionValue) {
                case 'to bottom':
                  gradientDirectionSvg =
                    'x1\x3d"0%" y1\x3d"0%" x2\x3d"0%" y2\x3d"100%"'
                  break
                case 'to right':
                  gradientDirectionSvg =
                    'x1\x3d"0%" y1\x3d"0%" x2\x3d"100%" y2\x3d"0%"'
                  break
                case 'to bottom right':
                  gradientDirectionSvg =
                    'x1\x3d"0%" y1\x3d"0%" x2\x3d"100%" y2\x3d"100%"'
                  break
                case 'to top right':
                  gradientDirectionSvg =
                    'x1\x3d"0%" y1\x3d"100%" x2\x3d"100%" y2\x3d"0%"'
                  break
                case 'ellipse':
                case 'ellipse at center':
                  gradientType = 'radial'
                  gradientDirectionSvg = 'cx\x3d"50%" cy\x3d"50%" r\x3d"75%"'
                  rectangleDimension =
                    'x\x3d"-50" y\x3d"-50" width\x3d"101" height\x3d"101"'
                  break
                default:
                  throw {
                    type: 'Argument',
              ...
              returner =
                '\x3csvg xmlns\x3d"http://www.w3.org/2000/svg" viewBox\x3d"0 0 1 1"\x3e' +
                '\x3c' +
                gradientType +
                'Gradient id\x3d"g" ' +
                gradientDirectionSvg +
              ...
              for (i = 0; i < stops.length; i += 1) {
                ...
                returner +=
                  ...
                  color.toRGB() +
                  '"' +
                  (alpha < 1 ? ' stop-opacity\x3d"' + alpha + '"' : '') +
                  '/\x3e'
              }
              returner +=
                '\x3c/' +
                ...
                '\x3crect ' +
                rectangleDimension +
                ' fill\x3d"url(#g)" /\x3e\x3c/svg\x3e'
        ...
        function (require, module, exports) {
          ...
          functionRegistry.addMultiple({
            ...
            'unit': function (val, unit) {
              ...
              if (unit)
                if (unit instanceof Keyword) unit = unit.value
        ...
        function (require, module, exports) {
          ...
          module.exports = function (environment) {
            ...
            ImportManager.prototype.push = function (
              ...
              if (options && options.templates[path])
                fileParsedFunc(null, options.templates[path], path)
              else {
                var promise,
                ...
                if (importOptions.isPlugin) {
                  ...
                  promise = fileManager.loadFile(
                    ...
                    function (err, loadedFile) {
                      if (err) fileParsedFunc(err)
                      else loadFileCallback(loadedFile)
                    }
                  )
                if (promise) promise.then(loadFileCallback, fileParsedFunc)
              }
            }
        ...
        function (require, module, exports) {
          module.exports = function (environment, fileManagers) {
            ...
            for (var n in initial.tree) {
              t = initial.tree[n]
              if (typeof t === 'function') api[n.toLowerCase()] = ctor(t)
              else {
                api[n] = Object.create(null)
                for (var o in t) api[n][o.toLowerCase()] = ctor(t[o])
              }
            }
            return api
          }
      ...
      38: [
        function (require, module, exports) {
          var utils = require('./utils')
          var LessError = (module.exports = function LessError(
            e,
            fileContentMap,
            currentFilename
          ) {
            ...
            if (fileContentMap && filename) {
              ...
              if (!this.line && this.stack) {
                var found = this.stack.match(
                  /(<anonymous>|Function):(\d+):(\d+)/
                )
                if (found) {
                  if (found[2]) this.line = parseInt(found[2]) - 2
          ...
          LessError.prototype.toString = function (options) {
            ...
            if (this.filename) message += stylize(' in ', 'red') + this.filename
            if (this.line)
              message += stylize(
        ...
        function (require, module, exports) {
          ...
          module.exports = function (environment, ParseTree, ImportManager) {
            var parse = function (input, options, callback) {
              ...
              } else options = utils.copyOptions(this.options, options || {})
              ...
              if (!callback) {
                ...
                if (options.plugins)
                  options.plugins.forEach(function (plugin) {
                    ...
                    } else pluginManager.addPlugin(plugin)
                  })
        ...
        function (require, module, exports) {
          module.exports = function (input, fail) {
            ...
            for (
              ...
              if ((cc >= 97 && cc <= 122) || cc < 34) continue
              switch (cc) {
                case 40:
                  parenLevel++
        ...
        function (require, module, exports) {
          ...
          module.exports = function () {
            ...
            parserInput.$char = function (tok) {
              if (input.charAt(parserInput.i) !== tok) return null
              skipWhitespace(1)
              return tok
            }
            ...
            parserInput.$parseUntil = function (tok) {
              ...
              do {
                ...
                if (blockDepth === 0 && testChar(nextChar)) {
                  ...
                  if (returnVal) parseGroups.push(returnVal)
                  ...
                  switch (nextChar) {
                    ...
                    case ']':
                      ...
                      if (nextChar === expected) blockDepth--
                      else {
                        skipWhitespace(i - startPos)
                        returnVal = expected
                        loop = false
            ...
            parserInput.start = function (str, chunkInput, failFunction) {
              ...
              if (chunkInput) chunks = chunker(str, failFunction)
              else chunks = [str]
              current = chunks[0]
              skipWhitespace(0)
            }
        ...
        function (require, module, exports) {
          ...
          var Parser = function Parser(context, imports, fileInfo) {
            ...
            function expectChar(arg, msg) {
              if (parserInput.$char(arg)) return arg
              error(
                msg ||
                  "expected '" +
                    arg +
            ...
            function parseNode(
              ...
              try {
                ...
                if (endInfo.isFinished) callback(null, returnNodes)
              ...
              parse: function (str, callback, additionalData) {
                ...
                var finish = function (e) {
                  ...
                  if (e) {
                    ...
                    return callback(e)
                  } else return callback(null, root)
                }
                if (context.processImports !== false)
                  new visitors.ImportVisitor(
                    imports,
                    finish,
                    additionalData
                  ).run(root)
              ...
              parsers: (parsers = {
                primary: function () {
                  ...
                  while (true) {
                    ...
                    if (node) root.push(node)
                      ...
                      while (parserInput.$char(';')) foundSemiColon = true
                ...
                entities: {
                  ...
                  quoted: function (forceEscaped) {
                    var str,
                      ...
                      isEscaped = false
                    parserInput.save()
                    if (parserInput.$char('~')) isEscaped = true
                  ...
                  call: function () {
                    var name,
                      ...
                      func,
                      index = parserInput.i
                    if (parserInput.peek(/^url\(/i)) return
                    parserInput.save()
                  ...
                  dimension: function () {
                    if (parserInput.peekNotNumeric()) return
                    var value = parserInput.$re(
                      /^([+-]?\d*\.?\d+)(%|[a-z_]+)?/i
                    )
                    if (value) return new tree.Dimension(value[1], value[2])
                  },
                  unicodeDescriptor: function () {
                    var ud
                    ud = parserInput.$re(/^U\+[0-9a-fA-F?]+(\-[0-9a-fA-F?]+)?/)
                    if (ud) return new tree.UnicodeDescriptor(ud[0])
                  },
                  javascript: function () {
                    var js,
                      index = parserInput.i
                ...
                variableCall: function (parsedName) {
                  ...
                  if (
                    ...
                    if (lookups && parsers.important()) important = true
                ...
                extend: function (isRule) {
                  var elements,
                    ...
                    extendList,
                    extend
                  if (!parserInput.$str(isRule ? '\x26:extend(' : ':extend('))
                    return
                  do {
                    option = null
                    elements = null
                    ...
                    if (extendList) extendList.push(extend)
                    else extendList = [extend]
                ...
                mixin: {
                  ...
                  elements: function () {
                    ...
                    while (true) {
                      ...
                      if (elements) elements.push(elem)
                      else elements = [elem]
                      c = parserInput.$char('\x3e')
                    }
                    return elements
                  },
                  args: function (isCall) {
                    ...
                    while (true) {
                      ...
                      if (!arg || !hasSep) break
                      nameLoop = null
                      if (arg.throwAwayComments) arg.throwAwayComments()
                      value = arg
                      var val = null
                      if (isCall) {
                      ...
                      if (
                        val &&
                        (val instanceof tree.Variable ||
                          val instanceof tree.Property)
                      )
                        if (parserInput.$char(':')) {
                ...
                ieAlpha: function () {
                  ...
                  expectChar(')')
                  return new tree.Quoted('', 'alpha(opacity\x3d' + value + ')')
                },
                element: function () {
                  var e,
                    c,
                ...
                combinator: function () {
                  ...
                  else return new tree.Combinator(null)
                },
                selector: function (isLess) {
                  ...
                  while (
                    ...
                    if (when)
                      ...
                      if (allExtends) allExtends = allExtends.concat(extendList)
                ...
                blockRuleset: function () {
                  ...
                  if (block) block = new tree.Ruleset(null, block)
                  return block
                },
                ...
                ruleset: function () {
                  ...
                  if (selectors && (rules = this.block())) {
                    ...
                    if (context.dumpLineNumbers) ruleset.debugInfo = debugInfo
                    return ruleset
                  } else parserInput.restore()
                },
                ...
                anonymousValue: function () {
                  ...
                  if (match) return new tree.Anonymous(match[1], index)
                },
                permissiveValue: function (untilTokens) {
                  ...
                  function testCurrentChar() {
                    var c = parserInput.currentChar()
                    if (typeof tok === 'string') return c === tok
                    else return tok.test(c)
                  }
                  ...
                  if (value) {
                    ...
                    for (i = 0; i < value.length; i++) {
                      ...
                      if (Array.isArray(item))
                        ...
                        if (i === value.length - 1) item = item.trim()
                        var quote = new tree.Quoted(
                          "'",
                          item,
                          true,
                          index,
                ...
                mediaFeature: function () {
                  ...
                  do {
                    ...
                    if (e) nodes.push(e)
                      ...
                      else error("Missing closing ')'", 'Parse')
                    }
                  } while (e)
                  parserInput.forget()
                  if (nodes.length > 0) return new tree.Expression(nodes)
                },
                ...
                media: function () {
                  var features,
                    ...
                    debugInfo,
                    index = parserInput.i
                  if (context.dumpLineNumbers) debugInfo = getDebugInfo(index)
                  parserInput.save()
                  if (parserInput.$str('@media')) {
                    ...
                    if (context.dumpLineNumbers) media.debugInfo = debugInfo
                    return media
                  }
                  parserInput.restore()
                },
                plugin: function () {
                  ...
                  if (dir) {
                    ...
                    if (args) options = { pluginArgs: args, isPlugin: true }
                ...
                atrule: function () {
                  ...
                  if (hasIdentifier) {
                    value = this.entity()
                    if (!value) error('expected ' + name + ' identifier')
                  } else if (hasExpression) {
                    value = this.expression()
                    if (!value) error('expected ' + name + ' expression')
                  } else if (hasUnknown) {
                    value = this.permissiveValue(/^[{;]/)
                    ...
                    if (!value) {
                      if (!hasBlock && parserInput.currentChar() !== ';')
                        error(
                          name + ' rule is missing block or ending semi-colon'
                        )
                ...
                condition: function (needsParens) {
                  ...
                  if (logical) {
                    ...
                    if (next) result = new tree.Condition(logical, result, next)
                    else return
                  }
                  return result
                },
                ...
                negatedCondition: function (needsParens) {
                  if (parserInput.$str('not')) {
                    ...
                    if (result) result.negate = !result.negate
                    return result
                  }
                },
                ...
                atomicCondition: function (needsParens) {
                  ...
                  a = cond()
                  if (a) {
                    if (parserInput.$char('\x3e'))
                      if (parserInput.$char('\x3d')) op = '\x3e\x3d'
                      else op = '\x3e'
                    else if (parserInput.$char('\x3c'))
                      if (parserInput.$char('\x3d')) op = '\x3c\x3d'
                      else op = '\x3c'
                    else if (parserInput.$char('\x3d'))
                      if (parserInput.$char('\x3e')) op = '\x3d\x3e'
                      else if (parserInput.$char('\x3c')) op = '\x3d\x3c'
                      else op = '\x3d'
                    if (op) {
                      b = cond()
                      if (b) c = new tree.Condition(op, a, b, index, false)
                ...
                expression: function () {
                  ...
                  if (entities.length > 0) return new tree.Expression(entities)
                },
                property: function () {
        ...
        function (require, module, exports) {
          ...
          var pm,
            PluginManagerFactory = function (less, newFactory) {
              if (newFactory || !pm) pm = new PluginManager(less)
              return pm
            }
          ...
          PluginManager.prototype.addPlugin = function (
            ...
            if (filename) this.pluginCache[filename] = plugin
            if (plugin.install)
              plugin.install(
                this.less,
                this,
          ...
          module.exports = function (SourceMapOutput, environment) {
            ...
            SourceMapBuilder.prototype.getCSSAppendage = function () {
              ...
              if (this.options.sourceMapFileInline) {
                if (this.sourceMap === undefined) return ''
                sourceMapURL =
                  'data:application/json;base64,' +
                  environment.encodeBase64(this.sourceMap)
              }
              if (sourceMapURL)
                return '/*# sourceMappingURL\x3d' + sourceMapURL + ' */'
              return ''
            }
          ...
          module.exports = function (environment) {
            ...
            SourceMapOutput.prototype.toCSS = function (context) {
              ...
              if (this._css.length > 0) {
                ...
                if (this.sourceMapURL) sourceMapURL = this.sourceMapURL
            ...
            if (options.pluginManager) {
              ...
              for (var i = 0; i < 2; i++) {
                ...
                while ((v = visitorIterator.get()))
                  ...
                  } else if (i === 0 || visitors.indexOf(v) === -1)
                    if (v.isPreVisitor) visitors.unshift(v)
                    else visitors.push(v)
              }
            }
      ...
      51: [
        function (require, module, exports) {
          ...
          Assignment.prototype.genCSS = function (context, output) {
            output.add(this.key + '\x3d')
            if (this.value.genCSS) this.value.genCSS(context, output)
            else output.add(this.value)
          }
        ...
        function (require, module, exports) {
          ...
          AtRule.prototype.accept = function (visitor) {
            var value = this.value,
              rules = this.rules
            if (rules) this.rules = visitor.visitArray(rules)
            if (value) this.value = visitor.visit(value)
          }
          ...
          AtRule.prototype.eval = function (context) {
            ...
            context.mediaPath = []
            context.mediaBlocks = []
            if (value) value = value.eval(context)
            if (rules) {
          ...
          AtRule.prototype.outputRuleset = function (context, output, rules) {
            ...
            if (!ruleCnt) output.add(' {' + tabSetStr + '}')
            else {
      ...
      54: [
        function (require, module, exports) {
          ...
          Call.prototype.accept = function (visitor) {
            if (this.args) this.args = visitor.visitArray(this.args)
          }
          Call.prototype.eval = function (context) {
            var currentMathContext = context.mathOn
            context.mathOn = !this.calc
            if (this.calc || context.inCalc) context.enterCalc()
            var args = this.args.map(function (a) {
              return a.eval(context)
            })
            if (this.calc || context.inCalc) context.exitCalc()
            context.mathOn = currentMathContext
            var result,
              funcCaller = new FunctionCaller(
                this.name,
                context,
                this.getIndex(),
                this.fileInfo()
            ...
            if (funcCaller.isValid()) {
              ...
              if (result !== null && result !== undefined) {
                if (!(result instanceof Node))
                  if (!result || result === true) result = new Anonymous(null)
      ...
      55: [
        function (require, module, exports) {
          ...
          var Color = function (rgb, a, originalForm) {
            var self = this
            if (Array.isArray(rgb)) this.rgb = rgb
            else if (rgb.length >= 6) {
              this.rgb = []
              rgb.match(/.{2}/g).map(function (c, i) {
                if (i < 3) self.rgb.push(parseInt(c, 16))
                else self.alpha = parseInt(c, 16) / 255
              })
            } else {
              this.rgb = []
              rgb.split('').map(function (c, i) {
                if (i < 3) self.rgb.push(parseInt(c + c, 16))
                else self.alpha = parseInt(c + c, 16) / 255
              })
            }
            this.alpha = this.alpha || (typeof a === 'number' ? a : 1)
            if (typeof originalForm !== 'undefined') this.value = originalForm
          }
          ...
          Color.fromKeyword = function (keyword) {
            ...
            if (colors.hasOwnProperty(key)) c = new Color(colors[key].slice(1))
      ...
      62: [
        function (require, module, exports) {
          ...
          Dimension.prototype.operate = function (context, op, other) {
            ...
            if (op === '+' || op === '-')
              if (
                ...
                if (this.unit.backupUnit) unit.backupUnit = this.unit.backupUnit
              } else if (
          ...
          Dimension.prototype.compare = function (other) {
            var a, b
            if (!(other instanceof Dimension)) return undefined
            if (this.unit.isEmpty() || other.unit.isEmpty()) {
              ...
              a = this.unify()
              b = other.unify()
              if (a.unit.compare(b.unit) !== 0) return undefined
            }
      ...
      63: [
        function (require, module, exports) {
          ...
          Element.prototype.accept = function (visitor) {
            ...
            if (typeof value === 'object') this.value = visitor.visit(value)
          }
          ...
          Element.prototype.toCSS = function (context) {
            ...
            if (value instanceof Paren) context.firstSelector = true
            value = value.toCSS ? value.toCSS(context) : value
            context.firstSelector = firstSelector
            if (value === '' && this.combinator.value.charAt(0) === '\x26')
              return ''
            else return this.combinator.toCSS(context) + value
          }
        ...
        function (require, module, exports) {
          ...
          Expression.prototype.genCSS = function (context, output) {
            for (var i = 0; i < this.value.length; i++) {
              ...
              if (!this.noSpacing && i + 1 < this.value.length) output.add(' ')
            }
          }
      ...
      66: [
        function (require, module, exports) {
          ...
          Import.prototype.accept = function (visitor) {
            if (this.features) this.features = visitor.visit(this.features)
          ...
          Import.prototype.isVariableImport = function () {
            var path = this.path
            if (path instanceof URL) path = path.value
          ...
          Import.prototype.doEval = function (context) {
            ...
            if (this.skip) {
              if (typeof this.skip === 'function') this.skip = this.skip()
              if (this.skip) return []
            }
            if (this.options.inline) {
              var contents = new Anonymous(
                ...
                0,
                {
                  ...
                  reference:
                    this.path._fileInfo && this.path._fileInfo.reference
                },
                true,
                true
              )
      ...
      68: [
        function (require, module, exports) {
          ...
          JavaScript.prototype.eval = function (context) {
            ...
            else return new Anonymous(result)
          }
      ...
      72: [
        function (require, module, exports) {
          ...
          MixinCall.prototype.accept = function (visitor) {
            if (this.selector) this.selector = visitor.visit(this.selector)
      ...
      73: [
        function (require, module, exports) {
          ...
          var Definition = function (
            ...
            this.selectors = [
              new Selector([
                new Element(null, name, false, this._index, this._fileInfo)
              ])
            ]
            this.params = params
          ...
          Definition.prototype.accept = function (visitor) {
            ...
            if (this.condition) this.condition = visitor.visit(this.condition)
          }
                ...
                if ((name = arg && arg.name)) {
                  ...
                  for (j = 0; j < params.length; j++)
                    if (!evaldArguments[j] && name === params[j].name) {
                      ...
                      frame.prependRule(
                        new Declaration(name, arg.value.eval(context))
                      )
                      isNamedFound = true
                      break
                    }
          ...
          Definition.prototype.makeImportant = function () {
            var rules = !this.rules
              ...
              : this.rules.map(function (r) {
                  if (r.makeImportant) return r.makeImportant(true)
                  else return r
                })
          ...
          Definition.prototype.evalCall = function (context, args, important) {
            var _arguments = [],
              mixinFrames = this.frames
                ? this.frames.concat(context.frames)
                : context.frames,
              frame = this.evalParams(
                context,
          ...
          Definition.prototype.matchArgs = function (args, context) {
            ...
            var requiredArgsCnt = !args
              ...
              : args.reduce(function (count, p) {
                  if (optionalParameters.indexOf(p.name) < 0) return count + 1
                  else return count
                }, 0)
            if (!this.variadic) {
              if (requiredArgsCnt < this.required) return false
      ...
      76: [
        function (require, module, exports) {
          ...
          Node.prototype.setParent = function (nodes, parent) {
            function set(node) {
              if (node && node instanceof Node) node.parent = parent
            }
          ...
          Node.compare = function (a, b) {
            ...
            a = a.value
            b = b.value
            if (!Array.isArray(a)) return a === b ? 0 : undefined
            if (a.length !== b.length) return undefined
            for (var i = 0; i < a.length; i++)
              if (Node.compare(a[i], b[i]) !== 0) return undefined
            return 0
          }
          ...
          Node.prototype.blocksVisibility = function () {
            if (this.visibilityBlocks == null) this.visibilityBlocks = 0
        ...
        function (require, module, exports) {
          ...
          Operation.prototype.eval = function (context) {
            ...
            if (context.isMathOn(this.op)) {
              op = this.op === './' ? '/' : this.op
              if (a instanceof Dimension && b instanceof Color) a = a.toColor()
              if (b instanceof Dimension && a instanceof Color) b = b.toColor()
              if (!a.operate) {
                if (
                  a instanceof Operation &&
                  a.op === '/' &&
                  context.math === MATH.PARENS_DIVISION
                )
            ...
            } else return new Operation(this.op, [a, b], this.isSpaced)
          }
      ...
      80: [
        function (require, module, exports) {
          ...
          Quoted.prototype.genCSS = function (context, output) {
            ...
            output.add(this.value)
            if (!this.escaped) output.add(this.quote)
          }
      ...
      81: [
        function (require, module, exports) {
          ...
          Ruleset.prototype.accept = function (visitor) {
            if (this.paths) this.paths = visitor.visitArray(this.paths, true)
          ...
          Ruleset.prototype.eval = function (context) {
            ...
            if (this.selectors && (selCnt = this.selectors.length)) {
              ...
              if (hasVariable) {
                ...
                this.parse.parseNode(
                  ...
                  function (err, result) {
                    if (result) selectors = utils.flattenArray(result)
                  }
                )
              }
              defaultFunc.reset()
            ...
            if (this.debugInfo) ruleset.debugInfo = this.debugInfo
            ...
            if (!ctxSelectors) context.selectors = ctxSelectors = []
            ctxSelectors.unshift(this.selectors)
            if (ruleset.root || ruleset.allowImports || !ruleset.strictImports)
              ruleset.evalImports(context)
            var rsRules = ruleset.rules
            for (i = 0; (rule = rsRules[i]); i++)
              if (rule.evalFirst) rsRules[i] = rule.eval(context)
            var mediaBlockCount =
            ...
            for (i = 0; (rule = rsRules[i]); i++)
              if (rule.type === 'MixinCall') {
                ...
                rules = rule.eval(context).rules.filter(function (r) {
                  if (r instanceof Declaration && r.variable) return false
                  return true
                })
                rsRules.splice.apply(rsRules, [i, 1].concat(rules))
                i += rules.length - 1
          ...
          Ruleset.prototype.makeImportant = function () {
            var result = new Ruleset(
              this.selectors,
              this.rules.map(function (r) {
                if (r.makeImportant) return r.makeImportant()
                else return r
              }),
              this.strictImports,
              this.visibilityInfo()
                    ...
                    if (r instanceof Declaration && r.variable !== true) {
                      var name =
                        r.name.length === 1 && r.name[0] instanceof Keyword
                          ? r.name[0].value
                          : r.name
                      if (!hash['$' + name]) hash['$' + name] = [r]
                      else hash['$' + name].push(r)
                    }
                    return hash
                  }, {})
          ...
          Ruleset.prototype.lastDeclaration = function () {
            for (var i = this.rules.length; i > 0; i--) {
              ...
              if (decl instanceof Declaration) return this.parseValue(decl)
            }
          }
          ...
          Ruleset.prototype.rulesets = function () {
            ...
            for (i = 0; (rule = rules[i]); i++)
              if (rule.isRuleset) filtRules.push(rule)
            return filtRules
          }
          Ruleset.prototype.prependRule = function (rule) {
            var rules = this.rules
            if (rules) rules.unshift(rule)
          ...
          Ruleset.prototype.genCSS = function (context, output) {
            ...
            if (!this.root) {
              ...
              for (i = 0; i < pathCnt; i++) {
                ...
                for (j = 1; j < pathSubCnt; j++) path[j].genCSS(context, output)
              }
            ...
            for (i = 0; (rule = ruleNodes[i]); i++) {
              ...
              if (rule.isRulesetLike(rule)) context.lastRule = false
          ...
          Ruleset.prototype.joinSelector = function (paths, context, selector) {
            ...
            function replaceParentSelector(paths, context, inSelector) {
              ...
              function findNestedSelector(element) {
                var maybeSelector
                if (!(element.value instanceof Paren)) return null
                maybeSelector = element.value.value
                if (!(maybeSelector instanceof Selector)) return null
      ...
      82: [
        function (require, module, exports) {
          ...
          Selector.prototype.accept = function (visitor) {
            if (this.elements) this.elements = visitor.visitArray(this.elements)
            if (this.extendList)
          ...
          Selector.prototype.getElements = function (els) {
            if (!els)
              return [
                new Element('', '\x26', false, this._index, this._fileInfo)
              ]
          ...
          Selector.prototype.match = function (other) {
            ...
            if (olen === 0 || len < olen) return 0
              ...
              for (i = 0; i < olen; i++)
                if (elements[i].value !== other[i]) return 0
            return olen
          }
          Selector.prototype.mixinElements = function () {
            ...
            var elements = this.elements
              ...
              .match(/[,&#\*\.\w-]([\w-]|(\\.))*/g)
            if (elements) {
              if (elements[0] === '\x26') elements.shift()
            } else elements = []
        ...
        function (require, module, exports) {
          ...
          var Unit = function (numerator, denominator, backupUnit) {
            ...
            this.denominator = denominator
              ...
              : []
            if (backupUnit) this.backupUnit = backupUnit
          ...
          Unit.prototype.genCSS = function (context, output) {
            ...
            if (this.numerator.length === 1) output.add(this.numerator[0])
          ...
          Unit.prototype.cancel = function () {
            ...
            for (atomicUnit in counter)
              if (counter.hasOwnProperty(atomicUnit)) {
                ...
                if (count > 0)
                  for (i = 0; i < count; i++) this.numerator.push(atomicUnit)
                else if (count < 0)
                  for (i = 0; i < -count; i++) this.denominator.push(atomicUnit)
              }
            this.numerator.sort()
          ...
          URL.prototype.eval = function (context) {
            ...
            if (!this.isEvald) {
              ...
              if (
                ...
                if (!val.quote) rootpath = escapePath(rootpath)
                val.value = context.rewritePath(val.value, rootpath)
              } else val.value = context.normalizePath(val.value)
              if (context.urlArgs)
                if (!val.value.match(/^\s*data:/)) {
                  var delimiter = val.value.indexOf('?') === -1 ? '?' : '\x26'
      ...
      86: [
        function (require, module, exports) {
          ...
          var Value = function (value) {
            if (!value) throw new Error('Value requires an array argument')
          ...
          Value.prototype.accept = function (visitor) {
            if (this.value) this.value = visitor.visitArray(this.value)
          }
          Value.prototype.eval = function (context) {
            if (this.value.length === 1) return this.value[0].eval(context)
            else
              return new Value(
        ...
        function (require, module, exports) {
          ...
          VariableCall.prototype.eval = function (context) {
            ...
            if (!detachedRuleset.ruleset) {
              if (detachedRuleset.rules) rules = detachedRuleset
          ...
          Variable.prototype.eval = function (context) {
            ...
            variable = this.find(context.frames, function (frame) {
              ...
              if (v) {
                ...
                else return v.value.eval(context)
              }
            })
            if (variable) {
              this.evaluating = false
        ...
        function (require, module, exports) {
          ...
          var utils = {
            ...
            copyOptions: function (obj1, obj2) {
              if (obj2 && obj2._defaults) return obj2
              var opts = utils.defaults(obj1, obj2)
              if (opts.strictMath) opts.math = Constants.Math.STRICT_LEGACY
            ...
            flattenArray: function (arr, result) {
              ...
              for (var i = 0, length = arr.length; i < length; i++) {
                var value = arr[i]
                if (Array.isArray(value)) utils.flattenArray(value, result)
            ...
            visitRuleset: function (rulesetNode, visitArgs) {
              ...
              for (i = 0; i < paths.length; i++) {
                ...
                extendList = selExtendList
                  ? utils
                      .copyArray(selExtendList)
                      .concat(allSelectorsExtendList)
                  : allSelectorsExtendList
                if (extendList)
          ...
          ProcessExtendsVisitor.prototype = {
            ...
            isElementValuesEqual: function (elementValue1, elementValue2) {
              ...
              if (elementValue1 instanceof tree.Attribute) {
                ...
                if (!elementValue1.value || !elementValue2.value) {
                  if (elementValue1.value || elementValue2.value) return false
                  return true
                }
            ...
            extendSelector: function (
              ...
              path = path.map(function (currentValue) {
                ...
                if (isVisible) derived.ensureVisibility()
        ...
        function (require, module, exports) {
          ...
          ImportSequencer.prototype.addImport = function (callback) {
            var importSequencer = this,
              importItem = { callback: callback, args: null, isReady: false }
      ...
      92: [
        function (require, module, exports) {
          var contexts = require('../contexts'),
            ...
            utils = require('../utils')
          var ImportVisitor = function (importer, finish, options) {
            this.options = options
            this._visitor = new Visitor(this)
          ...
          ImportVisitor.prototype = {
            ...
            processImportNode: function (importNode, context, importParent) {
              ...
              if (evaldImportNode && (!evaldImportNode.css || inlineCSS)) {
                ...
                this.importCount--
                if (this.isFinished) this._sequencer.tryRun()
              }
            },
            onImported: function (
              importNode,
              ...
              if (!context.importMultiple)
                if (duplicateImport) importNode.skip = true
                else
              ...
              if (importVisitor.isFinished) importVisitor._sequencer.tryRun()
            },
            visitDeclaration: function (declNode, visitArgs) {
              if (declNode.value.type === 'DetachedRuleset')
                this.context.frames.unshift(declNode)
              else visitArgs.visitDeeper = false
            },
        ...
        function (require, module, exports) {
          ...
          CSSVisitorUtils.prototype = {
            ...
            resolveVisibility: function (node, originalRules) {
              ...
              if (this.isEmpty(compiledRulesBody)) return
          ...
          ToCSSVisitor.prototype = {
            ...
            visitDeclaration: function (declNode, visitArgs) {
              if (declNode.blocksVisibility() || declNode.variable) return
              return declNode
            },
            ...
            visitImport: function (importNode, visitArgs) {
              if (importNode.blocksVisibility()) return
              return importNode
            },
            visitAtRule: function (atRuleNode, visitArgs) {
              if (atRuleNode.rules && atRuleNode.rules.length)
                return this.visitAtRuleWithBody(atRuleNode, visitArgs)
              else return this.visitAtRuleWithoutBody(atRuleNode, visitArgs)
            },
            ...
            visitAtRuleWithBody: function (atRuleNode, visitArgs) {
              ...
              function getBodyRules(atRuleNode) {
                ...
                if (hasFakeRuleset(atRuleNode)) return nodeRules[0].rules
                return nodeRules
              }
            ...
            visitAtRuleWithoutBody: function (atRuleNode, visitArgs) {
              if (atRuleNode.blocksVisibility()) return
              ...
              if (rulesetNode.paths)
                rulesetNode.paths = rulesetNode.paths.filter(function (p) {
                  ...
                  for (i = 0; i < p.length; i++)
                    if (p[i].isVisible() && p[i].getIsOutput()) return true
                  return false
                })
            },
            _removeDuplicateRules: function (rules) {
              ...
              for (i = rules.length - 1; i >= 0; i--) {
                ...
                if (rule instanceof tree.Declaration)
                  if (!ruleCache[rule.name]) ruleCache[rule.name] = rule
                  else {
                    ...
                    if (ruleList.indexOf(ruleCSS) !== -1) rules.splice(i, 1)
                    else ruleList.push(ruleCSS)
                  }
              }
            },
        ...
        function (require, module, exports) {
          ...
          Visitor.prototype = {
            visit: function (node) {
              ...
              if (!nodeTypeIndex) {
                if (node.value && node.value.typeIndex) this.visit(node.value)
                return node
              }
              ...
              if (func !== _noop) {
                ...
                if (node && impl.isReplacing) node = newNode
              }
        ...
        function (require, module, exports) {
          ...
          RawTask.prototype.call = function () {
            try {
              ...
              if (asap.onerror) asap.onerror(error)
              else {
