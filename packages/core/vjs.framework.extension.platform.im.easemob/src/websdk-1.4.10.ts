/******/ ;(function (modules) {
  ...
  /******/ {
    ...
    /***/ 217: /***/ function (module, exports, __webpack_require__) {
      ...
      ;(function () {
        ...
        var _tmpUtilXHR = _xmlrequest(),
          ...
          _isCanDownLoadFile =
            _isCanSetRequestHeader && (_hasBlob || _hasOverrideMimeType)
        ...
        var utils = {
          ...
          stringify: function stringify(json) {
            if (typeof JSON !== 'undefined' && JSON.stringify) {
              ...
              var iterate = function iterate(json) {
                ...
                for (var o in json) {
                  if (
                    Object.prototype.toString.call(json[o]) === '[object Null]'
                  ) {
                    json[o] = 'null'
                  } else if (
                    Object.prototype.toString.call(json[o]) ===
                    '[object Undefined]'
                  ) {
                    json[o] = 'undefined'
                  }
          ...
          uploadFile: function uploadFile(options) {
            ...
            var apiUrl = options.apiUrl
            var uploadUrl =
              apiUrl + '/' + orgName + '/' + appName + '/chatfiles'
    ...
    /***/ 225: /***/ function (module, exports, __webpack_require__) {
      ...
      var _listenNetwork = function _listenNetwork(
        onlineCallback,
        offlineCallback
      ) {
      ...
      var connection = function connection(options) {
        ...
        this.url =
          _getXmppUrl(options.url, this.https) + '?' + new Date().getTime()
      ...
      connection.prototype.heartBeat = function () {
        ...
        var isNeed =
          !/^ws|wss/.test(me.url) || /mobile/.test(navigator.userAgent)
      ...
      connection.prototype.handleMessage = function (msginfo) {
        ...
        if (error.length > 0) {
          ...
          window.console.log('handle error', errorCode, errorText)
        }
            ...
            switch (type) {
              ...
              case 'img':
                ...
                var msg = {
                  ...
                  url:
                    location.protocol != 'https:' && self.isHttpDNS
                      ? self.apiUrl +
                        msgBody.url.substr(msgBody.url.indexOf('/', 9))
                      : msgBody.url,
      ...
      connection.prototype.reconnect = function () {
        ...
        }, (this.autoReconnectNumTotal == 0 ? 0 : this.autoReconnectInterval) *
          1000)
      ...
      connection.prototype.getGroupBlacklist = function (options) {
        ...
        this.context.stropheConn.sendIQ(
          iq.tree(),
          function (msginfo) {
            window.console.log('getGroupBlackList')
          ...
          if (me.msg.file) {
            ...
            var _complete = function _complete(data) {
              if (data.entities[0]['file-metadata']) {
                var file_len =
                  data.entities[0]['file-metadata']['content-length']
                me.msg.file_length = file_len
                me.msg.filetype =
                  data.entities[0]['file-metadata']['content-type']
                if (file_len > 204800) {
              ...
              me.msg.body = {
                ...
                url:
                  (location.protocol != 'https:' && conn.isHttpDNS
                    ? conn.apiUrl + data.uri.substr(data.uri.indexOf('/', 9))
                    : data.uri) +
                  '/' +
