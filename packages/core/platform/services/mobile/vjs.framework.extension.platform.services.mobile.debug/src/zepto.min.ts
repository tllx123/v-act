          ...
          (S.onreadystatechange = function () {
            if (4 == S.readyState) {
              ...
              if (
                ...
                ;(u =
                  u || w(o.mimeType || S.getResponseHeader('content-type'))),
                  (e = S.responseText)
                try {
                  'script' == u
                    ? (1, eval)(e)
...
$(function () {
  ...
  let $overlay = $('.overlay')
  function openPanel() {
    $box.addClass('openPanel')
    $overlay.removeClass('hide')
  }
  function closePanel() {
    $box.removeClass('openPanel')
    $overlay.addClass('hide')
    return false
  }
  $('.toggle-panel').bind('touchstart', openPanel)
  $('.overlay').bind('touchend', closePanel)
  $('.panel-main a').bind('click', closePanel)
  /*label*/
  $('#form-list li')
    .find('label')
    .bind('click', function () {
  ...
  $('input:not(.switch)')
    .focus(function () {
      $(this).parents('.border-bottom').addClass('blue-line')
    })
    .blur(function () {
      $(this).parents('.border-bottom').removeClass('blue-line')
    })
})
