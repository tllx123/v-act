    ...
    let c,
      ...
      A = function (a) {
        ...
        if (d) {
          ...
          let h = b.features.isOldAndroid ? 600 : 30
      ...
      H = function () {
        for (let a, b, c, d, e, f = '', g = 0; g < q.shareButtons.length; g++)
          (a = q.shareButtons[g]),
      ...
      I = function (a) {
        for (let c = 0; c < q.closeElClasses.length; c++)
      ...
      L = function (a) {
        a = a ? a : window.event
        let b = a.relatedTarget || a.toElement
        ;(b && 'HTML' !== b.nodeName) ||
          (clearTimeout(u),
      ...
      T = function () {
        ...
        f(d.children)
        let g = b.getChildByClass(d, 'pswp__top-bar')
        g && f(g.children)
      }
    ;(v.init = function () {
