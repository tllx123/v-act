 ...
 */
define('./ds', function (require, exports, module) {
...
vds.ds.register("persion",datasource);
  ...
  export function merge(
    ...
    if (mergeType == 'updateRecord' && isClearDatas == true)
      isClearDatas = false
    ...
    var isNotFieldEntity =
      !extraParams || extraParams.sourceType != 'fieldEntity'
    if (
      undefined != records &&
      null != records &&
