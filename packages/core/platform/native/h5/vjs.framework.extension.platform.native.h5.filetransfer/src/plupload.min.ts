  ...
  i(u, [], function () {
        ...
        t.extend(this, {
          ...
          addEventListener: function (e, i, r, o) {
            ...
            return (
              (e = t.trim(e)),
              /\s/.test(e)
                ? void t.each(e.split(/\s+/), function (e) {
    ...
    i(v, [h, u, g], function (e, t, n) {
      return function i() {
        var i
        t.extend(this, {
          connectRuntime: function (r, uploader) {
            function o(t) {
              var s, u
              return t.length
                ? ((s = t.shift()),
                  (u = n.getConstructor(s))
                    ? ((i = new u(r)),
                      ...
                      i.mode ? void i.init() : void i.trigger('Error'))
                    : void o(t))
                : (a.trigger(
                    'RuntimeError',
            ...
            o((r.runtime_order || n.order).split(/\s*,\s*/), uploader)
          },
          getRuntime: function () {
                      ...
                      function () {
                        ...
                        ;(c.files = []),
                          e.each(t, function (e) {
                            return 0 === e.size
                              ? !0
                              : void c.files.push(new a(c.ruid, e))
                          })
                      },
                      999
                    ),
          ...
          e.extend(this, y, {
            ...
            send: function (n, r) {
              ...
              this.withCredentials ||
                (this.withCredentials =
                  P.required_caps &&
                  P.required_caps.send_browser_cookies &&
                  !L),
    ...
    i(
      I,
      [u, f, h, T, S, g, v, O, d, p, y, w, m],
      function (e, t, n, i, r, o, a, s, u, c, l, d, f) {
        function h() {
          function i(e) {
            ...
            ;(a = s),
              ...
              (d.innerHTML =
                ...
                (a.directory && c.can('select_folder')
                  ...
                  : '') +
                (c.uploader.fileMimeType
                  ? ' accept="' + c.uploader.fileMimeType + '"'
                  : f
                  ? ' accept="' + f.join(',') + '"'
                  : '') +
                (c.uploader.useCamera ? ' capture="camera"' : '') +
                ' />'),
              (l = n.get(c.uid)),
              t.extend(l.style, {
                position: 'absolute',
              ...
              i.addEvent(
                ...
                function (n) {
                  e(n) &&
                    ...
                    n.dataTransfer.items[0].webkitGetAsEntry
                      ? s(n.dataTransfer.items, function () {
                          r.trigger('drop')
                        })
        ...
        t.extend(this, {
          send: function (n, r) {
            var s = this,
              ...
              m = !1
            if (
              ((p = n.url.replace(/^.+?\/([\w\-\.]+)$/, '$1').toLowerCase()),
              (h = c()),
            ...
            h.upload
              ? (n.withCredentials && (h.withCredentials = !0),
                    ...
                    case 3:
                      ...
                      try {
                        i.hasSameOrigin(n.url) &&
                          (e = h.getResponseHeader('Content-Length') || 0),
          ...
          for (r = 0; i > r; r++)
            if (((h = f = e + 12 * r + 2), (s = n[a.SHORT(h)]), s !== t)) {
              switch (
                ...
                case 7:
                  for (
                    d > 4 && (h = a.LONG(h) + c.tiffHeader), o = 0;
                    d > o;
                    o++
                  )
                    m[o] = a.BYTE(h + o)
                ...
                case 3:
                  for (
                    d > 2 && (h = a.LONG(h) + c.tiffHeader), o = 0;
                    d > o;
                    o++
                  )
                    m[o] = a.SHORT(h + 2 * o)
                ...
                case 4:
                  for (
                    d > 1 && (h = a.LONG(h) + c.tiffHeader), o = 0;
                    d > o;
                    o++
                  )
                    m[o] = a.LONG(h + 4 * o)
              ...
              ;(p = 1 == d ? m[0] : m),
                (g[s] =
                  l.hasOwnProperty(s) && 'object' != typeof p ? l[s][p] : p)
            }
          return g
        }
        function r() {
            ...
            init: function (e) {
              return (
                ...
                e !== t && e.length
                  ? (a.init(e),
                    65505 === a.SHORT(0) &&
                    'EXIF\x00' === a.STRING(4, 5).toUpperCase()
                      ? r()
                      : !1)
                  : !1
              )
      ...
      function c() {
        ...
        function h(n, i, r, o) {
          ...
          return (
            (d = e()),
            r
              ? ((n = Math.min(n, d.width)),
                (i = Math.min(i, d.height)),
                (s = Math.max(n / d.width, i / d.height)))
              : (s = Math.min(n / d.width, i / d.height)),
            s > 1 && !r && o
        ...
        t.extend(this, {
          loadFromBlob: function (e) {
            ...
            return (
              (x = e),
              e.isDetached()
                ? ((_ = e.getSource()), void d.call(this, _))
                : void f.call(this, e.getSource(), function (e) {
                    r && (_ = c(e)), d.call(t, e)
                  })
            )
          },
          ...
          getAsBlob: function (e, t) {
            return (
              e !== this.type && h.call(this, this.width, this.height, !1),
              new r(null, {
                name: x.name || '',
                type: e,
...
;(function (e) {
  ...
  return (
    (function r(e) {
      ...
      for (i in e)
        (s = typeof e[i]),
          s === 'object' && !~n(i, ['Exceptions', 'Env', 'Mime'])
            ? r(e[i])
            : s === 'function' && (t[i] = e[i])
    })(e.moxie),
                ...
                e instanceof t.Blob
                  ...
                  ? (n && (e.name = n),
                    u.push(function (t) {
                      c(e, function (n) {
                        n ||
                          (f.push(e), a.push(e), s.trigger('FileFiltered', e)),
                          r(t, 1)
                      })
                    }))
