    ...
    var handler = scopeManager.createScopeHandler({
      handler: function (widgetCode, cfg) {
        ...
        if (flag) {
                ...
                var success = function () {
                    ...
                    try {
                      ...
                      eventManager.addEventHandler(
                        ...
                        function () {
                          ...
                          widgetAction.executeComponentAction('closeWindow')
                          if (typeof closedCallback == 'function') {
                            closedCallback(getWindowOutputParams(innerScopeId))
                          }
                  ...
                  componentUtil.renderComponentById(
                    ...
                    inputParam || {},
                    {
                      ...
                      inited: function () {
                        if (typeof callback == 'function') callback(newScopeId)
                    ...
                    var exceptionModalCloseHandle = (function (_exeception) {
                      return function () {
                        ...
                        if (
                          ...
                          typeof _exeception.getModalClosedHandler == 'function'
                        ) {
          ...
          tmp_addTabParams['beforeOpen'] = function (oldScopeId, successback) {
            //单页页签打开时调用
