define('./vPlatformVue', function (require, exports, module) {
  var scopeManager, widgetContext, dataSourceManager, V3ComponentVue, V3Vue
  ...
  export function initModule(sb) {
    ...
    V3ComponentVue = sb.getService(
      'vjs.framework.extension.platform.plugin.script.vue.V3ComponentVue'
    )
    V3Vue = sb.getService(
      'vjs.framework.extension.platform.plugin.script.vue.V3Vue'
    )
  }
