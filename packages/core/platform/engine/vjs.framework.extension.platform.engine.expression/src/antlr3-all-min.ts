...
org.antlr.runtime.BitSet.prototype = {
  ...
  getSingleElement: function () {
    ...
    for (
      A = 0;
      A < this.bits.length << org.antlr.runtime.BitSet.LOG_BITS;
      A++
    ) {
      if (this.member(A)) {
        return A
  ...
  toArray: function () {
    ...
    for (
      C = 0;
      C < this.bits.length << org.antlr.runtime.BitSet.LOG_BITS;
      C++
    ) {
      if (this.member(C)) {
        A[B++] = C
  ...
  toString1: function (D) {
    ...
    for (
      B = 0;
      B < this.bits.length << org.antlr.runtime.BitSet.LOG_BITS;
      B++
    ) {
      if (this.member(B)) {
        if (B > 0 && C) {
...
org.antlr.runtime.BaseRecognizer.prototype = {
  ...
  getErrorMessage: function (E, D) {
    var F = E && E.getMessage ? E.getMessage() : null,
      A,
      C
    if (E instanceof org.antlr.runtime.UnwantedTokenException) {
      ...
      if (E instanceof org.antlr.runtime.MissingTokenException) {
        A = E
        C = '<unknown>'
        if (A.expecting == org.antlr.runtime.Token.EOF) {
          C = 'EOF'
        } else {
          C = D[A.expecting]
        }
  ...
  getTokenErrorDisplay: function (A) {
    var B = A.getText()
    if (!org.antlr.lang.isValue(B)) {
      if (A.getType() == org.antlr.runtime.Token.EOF) {
        B = '<EOF>'
      } else {
        B = '<' + A.getType() + '>'
      }
  ...
  recover: function (A, B) {
    if (this.state.lastErrorIndex == A.index()) {
      A.consume()
    }
    this.state.lastErrorIndex = A.index()
    var C = this.computeErrorRecoverySet()
    this.beginResync()
  ...
  combineFollows: function (C) {
    ...
    for (B = E; B >= 0; B--) {
      ...
      if (C) {
        if (A.member(org.antlr.runtime.Token.EOR_TOKEN_TYPE)) {
          if (B > 0) {
            D.remove(org.antlr.runtime.Token.EOR_TOKEN_TYPE)
          }
        } else {
          break
        }
  ...
  recoverFromMismatchedToken: function (B, F, A) {
    ...
    if (this.mismatchIsUnwantedToken(B, F)) {
      ...
      this.endResync()
      this.reportError(E)
      var D = this.getCurrentInputSymbol(B)
      B.consume()
      return D
    }
    if (this.mismatchIsMissingToken(B, A)) {
      var C = this.getMissingSymbol(B, E, F, A)
  ...
  getRuleMemoization: function (B, A) {
    if (!this.state.ruleMemo[B]) {
      this.state.ruleMemo[B] = {}
    }
    var C = this.state.ruleMemo[B][A]
    if (!org.antlr.lang.isNumber(C)) {
  ...
  alreadyParsedRule: function (B, C) {
    var A = this.getRuleMemoization(C, B.index())
    if (A == org.antlr.runtime.BaseRecognizer.MEMO_RULE_UNKNOWN) {
      return false
    }
...
org.antlr.runtime.Lexer = function (A, B) {
  if (B) {
    org.antlr.runtime.Lexer.superclass.constructor.call(this, B)
  }
  if (A) {
    this.input = A
  }
...
org.antlr.lang.extend(
  ...
  org.antlr.runtime.BaseRecognizer,
  {
      ...
      while (true) {
        ...
        try {
          ...
          if (!org.antlr.lang.isValue(this.state.token)) {
            ...
            if (this.state.token == org.antlr.runtime.Token.SKIP_TOKEN) {
              continue
            }
          }
    ...
    emit: function () {
      if (arguments.length === 0) {
        var A = new org.antlr.runtime.CommonToken(
          this.input,
          this.state.type,
          this.state.channel,
            ...
            if (B instanceof org.antlr.runtime.MismatchedNotSetException) {
              ...
              if (B instanceof org.antlr.runtime.MismatchedSetException) {
                ...
                if (B instanceof org.antlr.runtime.MismatchedRangeException) {
                  ...
                  C = org.antlr.runtime.Lexer.superclass.getErrorMessage.call(
                    this,
                    B,
                    A
                  )
...
org.antlr.lang.extend(
  ...
  org.antlr.runtime.BaseRecognizer,
  {
    ...
    getMissingSymbol: function (C, G, E, A) {
      var B = '<missing ' + this.getTokenNames()[E] + '>'
      var D = new org.antlr.runtime.CommonToken(E, B)
      var F = C.LT(1)
      var H
...
org.antlr.runtime.DFA.prototype = {
  predict: function (C) {
    ...
    try {
      while (true) {
        ...
        E = C.LA(1)
        if (E === org.antlr.runtime.Token.EOF) {
          E = -1
        } else {
          if (org.antlr.lang.isString(E)) {
            E = E.charCodeAt(0)
  ...
  noViableAlt: function (C, A) {
    ...
    var B = new org.antlr.runtime.NoViableAltException(
      this.getDescription(),
      this.decisionNumber,
      C,
      A
...
;(function () {
  var A = org.antlr.runtime.tree.TreeParser
  org.antlr.lang.augmentObject(A, {
  ...
  org.antlr.lang.extend(A, org.antlr.runtime.BaseRecognizer, {
    ...
    getMissingSymbol: function (D, F, E, B) {
      var C = '<missing ' + this.getTokenNames()[E] + '>'
