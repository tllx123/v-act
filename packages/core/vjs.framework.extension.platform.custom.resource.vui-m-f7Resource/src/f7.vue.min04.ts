...
;(function (global, factory) {
  ...
  let VueRouter = {
    proto: {
      ...
      tabComponentLoader: function tabComponentLoader(
        tabEl,
        component,
        componentUrl,
        options,
      ...
      modalComponentLoader: function modalComponentLoader(
        rootEl,
        component,
        componentUrl,
        options,
  ...
  let Mixins = {
    ...
    colorClasses: function colorClasses(self) {
      ...
      return (
        ...
        (obj['color-theme-' + colorTheme] = colorTheme),
        (obj['text-color-' + textColor] = textColor),
        (obj['bg-color-' + bgColor] = bgColor),
        (obj['border-color-' + borderColor] = borderColor),
        (obj['ripple-color-' + rippleColor] = rippleColor),
        obj
      )
    },
    linkIconProps: {
    ...
    linkRouterAttrs: function linkRouterAttrs(self) {
      ...
      return {
        ...
        'data-animate':
          'animate' in self.$options.propsData ? animate.toString() : undefined,
    ...
    linkActionsAttrs: function linkActionsAttrs(self) {
      ...
      return {
        'data-panel':
          (Utils.isStringProp(panelOpen) && panelOpen) ||
          (Utils.isStringProp(panelClose) && panelClose),
        'data-popup':
          (Utils.isStringProp(popupOpen) && popupOpen) ||
          (Utils.isStringProp(popupClose) && popupClose),
        'data-actions':
          (Utils.isStringProp(actionsOpen) && actionsOpen) ||
          (Utils.isStringProp(actionsClose) && actionsClose),
        'data-popover':
          (Utils.isStringProp(popoverOpen) && popoverOpen) ||
          (Utils.isStringProp(popoverClose) && popoverClose),
        'data-sheet':
          (Utils.isStringProp(sheetOpen) && sheetOpen) ||
          (Utils.isStringProp(sheetClose) && sheetClose),
        'data-login-screen':
          (Utils.isStringProp(loginScreenOpen) && loginScreenOpen) ||
          (Utils.isStringProp(loginScreenClose) && loginScreenClose),
        'data-sortable':
          (Utils.isStringProp(sortableEnable) && sortableEnable) ||
  ...
  let f7AccordionContent = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'accordion-item-content', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let AccordionItemProps = Utils.extend(
    {
      opened: Boolean
    },
    Mixins.colorProps
    ...
    render: function () {
      ...
      return _c(
        'div',
        {
          ...
          class: _vm.classes,
          on: {
            'accordion:open': _vm.onOpen,
            'accordion:opened': _vm.onOpened,
            'accordion:close': _vm.onClose,
            'accordion:closed': _vm.onClosed
          }
        },
        [_vm._t('default')],
        2
  ...
  let f7AccordionToggle = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'accordion-item-toggle', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let f7Accordion = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'accordion-list', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let ActionsButtonProps = Utils.extend(
    {
      bold: Boolean,
      close: {
        type: Boolean,
  ...
  let ActionsLabelProps = Utils.extend(
    {
      bold: Boolean
    },
    Mixins.colorProps
    ...
    methods: {
      ...
      onF7Ready: function onF7Ready() {
        ...
        this.$nextTick(function () {
          ...
          if (self.target) {
            actionsParams.targetEl = self.target
          }
          if (typeof self.$options.propsData.convertToPopover !== 'undefined') {
            actionsParams.convertToPopover = self.convertToPopover
          }
          if (typeof self.$options.propsData.forceToPopover !== 'undefined') {
            actionsParams.forceToPopover = self.forceToPopover
          }
  ...
  let f7Badge = {
    render: function () {
      ...
      return _c(
        'span',
        { staticClass: 'badge', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let f7BlockFooter = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'block-footer', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let f7BlockHeader = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'block-header', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let f7BlockTitle = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'block-title', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
    ...
    render: function () {
      ...
      return _c(
        'div',
        {
          staticClass: 'block',
          class: _vm.classes,
          on: { 'tab:show': _vm.onTabShow, 'tab:hide': _vm.onTabHide }
        },
        [_vm._t('default')],
        2
      )
    ...
    render: function () {
      ...
      return _c(
        'i',
        {
          staticClass: 'icon',
          class: _vm.classes,
          style: { 'font-size': _vm.sizeComputed }
        },
        [_vm._v(_vm._s(_vm.iconTextComputed)), _vm._t('default')],
        2
      )
    },
    staticRenderFns: [],
    ...
    computed: {
      ...
      iconTextComputed: function iconTextComputed() {
        ...
        if (
          self.ifMd &&
          self.$theme.md &&
          (self.ifMd.indexOf('material:') >= 0 || self.ifMd.indexOf('f7:') >= 0)
        ) {
          text = self.ifMd.split(':')[1]
        } else if (
          self.ifIos &&
          self.$theme.ios &&
          (self.ifIos.indexOf('material:') >= 0 ||
            self.ifIos.indexOf('f7:') >= 0)
        ) {
      ...
      classes: function classes() {
        ...
        if (self.ifMd || self.ifIos) {
          ...
          if (this.ion) {
            classes['ion-' + this.ion] = true
          }
          if (this.fa) {
            classes['fa-' + this.fa] = true
          }
          if (this.icon) {
  ...
  let CardContentProps = Utils.extend(
    {
      padding: {
        type: Boolean,
        default: true
  ...
  let f7CardContent = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'card-content', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let f7CardFooter = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'card-footer', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let f7CardHeader = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'card-header', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let f7Card = {
    ...
    render: function render(c) {
      ...
      if (self.content || (self.$slots && self.$slots.content)) {
        contentEl = c('f7-card-content', { props: { padding: self.padding } }, [
          self.content,
          self.$slots.content
        ])
      }
      ...
      return c('div', { staticClass: 'card', class: self.classes }, [
        headerEl,
        contentEl,
        footerEl,
        self.$slots.default
  ...
  let CheckboxProps = Utils.extend(
    {
      checked: Boolean,
      name: [Number, String],
  ...
  let f7Chip = {
    ...
    render: function render(c) {
      ...
      if (self.media || (self.$slots && self.$slots.media)) {
        mediaEl = c(
          'div',
          { staticClass: 'chip-media', class: self.mediaClasses },
          self.media || self.$slots.media
        )
      }
      if (self.text || (self.$slots && self.$slots.text)) {
        labelEl = c('div', { staticClass: 'chip-label' }, [
          self.text,
          self.$slots.text
        ])
      }
    ...
    computed: {
      ...
      mediaClasses: function mediaClasses() {
        var c = {}
        if (this.mediaTextColor) {
          c['text-color-' + this.mediaTextColor] = true
        }
        if (this.mediaBgColor) {
          c['bg-color-' + this.mediaBgColor] = true
        }
        return c
      }
    },
    ...
    computed: {
      classes: function classes() {
        ...
        return Utils.extend(
          ...
          (obj['col-' + self.width] = self.width !== 'auto'),
          (obj['tablet-' + self.tabletWidth] = self.tabletWidth),
          (obj['desktop-' + self.desktopWidth] = self.desktopWidth),
          obj),
          Mixins.colorClasses(self)
        )
      }
  ...
  let FabButtonProps = Utils.extend(
    {
      fabClose: Boolean
    },
    Mixins.colorProps
  ...
  let FabButtonsProps = Utils.extend(
    {
      position: {
        type: String,
        default: 'top'
  ...
  let f7FabButtons = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'fab-buttons', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let f7Toggle = {
    ...
    methods: {
      toggle: function toggle() {
        var self = this
        if (self.f7Toggle && self.f7Toggle.setValue) {
  ...
  let f7Input = {
    ...
    render: function render(c) {
      ...
      if (
        ...
        if (self.type === 'select') {
          ...
          inputEl = c(
            'input',
            { attrs: attrs, style: self.inputStyle, on: on },
            self.$slots.default
          )
        } else {
          inputEl = c(
        ...
        (self.$slots.default && self.$slots.default.length > 0) ||
        !self.type
      ) {
      ...
      while ($parent && !foundItemContent) {
        ...
        if (
          tag &&
          (tag.indexOf('list-item') > 0 || tag.indexOf('list-item-content') > 0)
        ) {
      ...
      if (foundItemContent) {
        foundItemContent.itemInputForced = true
      }
      if (
        foundItemContent &&
        (self.info || (self.$slots.info && self.$slots.info.length))
      ) {
        foundItemContent.itemInputWithInfoForced = true
      }

      var infoEl
      if (self.info || (self.$slots.info && self.$slots.info.length)) {
        infoEl = c('div', { staticClass: 'item-input-info' }, [
          self.info,
          self.$slots.info
        ])
      }

      var itemInput = self.wrap
        ? c('div', { staticClass: 'item-input-wrap', class: self.classes }, [
            inputEl,
            clearButtonEl,
            infoEl
          ])
    ...
    watch: {
      value: function value() {
        var self = this
        if (self.type === 'range' || self.type === 'toggle') {
          return
        }
        var f7 = self.$f7
        if (!f7) {
        ...
        var inputEl = self.wrap
          ? self.$el.querySelector('input, select, textarea')
          : self.$el
        self.$nextTick(function () {
  ...
  let f7Label = {
    ...
    render: function render(c) {
      ...
      if (self.inline) {
        ...
        while ($parent && !foundItemContent) {
          ...
          if (
            ...
            (tag.indexOf('list-item') > 0 ||
              tag.indexOf('list-item-content') > 0)
          ) {
            foundItemContent = $parent
          }
          $parent = $parent.$parent
        ...
        if (foundItemContent) {
          foundItemContent.inlineLabelForced = true
        }
      }
    ...
    render: function render(c) {
      ...
      if (self.text) {
        if (self.badge) {
          badgeEl = c(
            'f7-badge',
            { props: { color: self.badgeColor } },
            self.badge
          )
        }
        textEl = c('span', { class: { 'tabbar-label': isTabbarLabel } }, [
          self.text,
          badgeEl
        ])
      }
      if (
        ...
        self.iconFa ||
        self.iconF7 ||
        (self.iconIfMd && self.$theme.md) ||
        (self.iconIfIos && self.$theme.ios)
      ) {
        if (self.iconBadge) {
          iconBadgeEl = c(
            'f7-badge',
  ...
  let ListButtonProps = Utils.extend(
    {
      noFastclick: Boolean,
      noFastClick: Boolean,
      title: [String, Number],
    ...
    computed: {
      attrs: function attrs() {
        ...
        return Utils.extend(
          {
            'href':
              typeof link === 'boolean' && typeof href === 'boolean'
                ? '#'
                : link || href,
            'target': target,
            'data-tab': Utils.isStringProp(tabLink) && tabLink
  ...
  let ListGroupProps = Utils.extend(
    {
      mediaList: Boolean,
      sortable: Boolean
    },
  ...
  let f7ListGroup = {
    render: function () {
      ...
      var _h = _vm.$createElement
      var _c = _vm._self._c || _h
      return _c('div', { staticClass: 'list-group', class: _vm.classes }, [
  ...
  let ListIndexProps = Utils.extend(
    {
      init: {
        type: Boolean,
        default: true
  ...
  let f7ListIndex = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'list-index', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let f7ListItemCell = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'item-cell', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let ListItemContentProps = Utils.extend(
    {
      title: [String, Number],
      text: [String, Number],
      media: String,
  ...
  let f7ListItemContent = {
    ...
    render: function render(c) {
      ...
      if (self.$slots.default && self.$slots.default.length > 0) {
        for (var i = 0; i < self.$slots.default.length; i += 1) {
          var slotName = self.$slots.default[i].data
            ? self.$slots.default[i].data.slot
            : undefined
          ...
          if (slotName === 'content-end') {
            slotsContentEnd.push(self.$slots.default[i])
          }
          ...
          if (slotName === 'after-end') {
            slotsAfterEnd.push(self.$slots.default[i])
          }
          if (slotName === 'media') {
          ...
          if (slotName === 'inner-end') {
            slotsInnerEnd.push(self.$slots.default[i])
          }
          if (slotName === 'before-title') {
            slotsBeforeTitle.push(self.$slots.default[i])
          }
          if (slotName === 'title') {
            slotsTitle.push(self.$slots.default[i])
          }
          if (slotName === 'after-title') {
            slotsAfterTitle.push(self.$slots.default[i])
          }
          if (slotName === 'subtitle') {
            slotsSubtitle.push(self.$slots.default[i])
          }
          if (slotName === 'text') {
            slotsText.push(self.$slots.default[i])
          }
          if (slotName === 'header') {
            slotsHeader.push(self.$slots.default[i])
          }
          if (slotName === 'footer') {
            slotsFooter.push(self.$slots.default[i])
          }
        }
      }
      ...
      if (self.radio || self.checkbox) {
        ...
        inputIconEl = c('i', {
          staticClass: 'icon icon-' + (self.radio ? 'radio' : 'checkbox')
        })
      }
      // Media
      if (self.media || slotsMedia.length) {
        ...
        mediaEl = c('div', { staticClass: 'item-media' }, [
          mediaImgEl,
          slotsMedia
        ])
      }
      ...
      if (self.header || slotsHeader.length) {
        headerEl = c('div', { staticClass: 'item-header' }, [
          self.header,
          slotsHeader
        ])
      }
      if (self.footer || slotsFooter.length) {
        footerEl = c('div', { staticClass: 'item-footer' }, [
          self.footer,
          slotsFooter
        ])
      }
      if (self.title || slotsTitle.length) {
        titleEl = c('div', { staticClass: 'item-title' }, [
          !self.mediaList && headerEl,
          self.title,
          slotsTitle,
          !self.mediaList && footerEl
        ])
      }
      if (self.subtitle || slotsSubtitle.length) {
        subtitleEl = c('div', { staticClass: 'item-subtitle' }, [
          self.subtitle,
          slotsSubtitle
        ])
      }
      ...
      if (self.after || self.badge || slotsAfter.length) {
        ...
        if (self.badge) {
          badgeEl = c('f7-badge', { props: { color: self.badgeColor } }, [
            self.badge
          ])
        }
        afterWrapEl = c('div', { staticClass: 'item-after' }, [
          slotsAfterStart,
          afterEl,
          badgeEl,
          slotsAfter,
      ...
      if (self.mediaList) {
        titleRowEl = c('div', { staticClass: 'item-title-row' }, [
          slotsBeforeTitle,
          titleEl,
          slotsAfterTitle,
          afterWrapEl
      ...
      // Finalize
      return c(
        self.checkbox || self.radio ? 'label' : 'div',
        {
          ...
          class: Utils.extend(
            {
              ...
              'item-input-with-info':
                self.itemInputWithInfo || self.itemInputWithInfoForced
            },
            Mixins.colorClasses(self)
          ),
          on: {
  ...
  let f7ListItemRow = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'item-row', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let ListItemProps = Utils.extend(
    {
      title: [String, Number],
      text: [String, Number],
      media: String,
  ...
  let f7ListItem = {
    ...
    render: function render(c) {
      ...
      if (!self.simpleListComputed) {
        ...
        itemContentEl = c(
          'f7-list-item-content',
          {
            ...
            on:
              self.link || self.href || self.accordionItem || self.smartSelect
                ? {}
                : { click: self.onClick, change: self.onChange }
          },
          [
          ...
          linkEl = c(
            'a',
            {
              attrs: Utils.extend(
                {
                  href:
                    self.link === true || self.accordionItem || self.smartSelect
                      ? '#'
                      : self.link || self.href,
                  target: self.target
                },
      ...
      if (self.divider || self.groupTitle) {
        ...
        var linkItemEl =
          self.link || self.href || self.smartSelect || self.accordionItem
            ? linkEl
            : itemContentEl
        if (self.swipeout) {
          liChildren = [
            c('div', { class: { 'swipeout-content': true } }, [linkItemEl])
          ]
        } else {
    ...
    computed: {
      ...
      simpleListComputed: function simpleListComputed() {
        return (
          ...
          (this.$parent.$parent && this.$parent.simpleList)
        )
      }
    },
    beforeDestroy: function beforeDestroy() {
    ...
    methods: {
      onF7Ready: function onF7Ready(f7) {
        ...
        var smartSelectParams = Utils.extend(
          { el: self.$el.querySelector('a.smart-select') },
          self.smartSelectParams || {}
        )
    ...
    methods: {
      ...
      onF7Ready: function onF7Ready(f7) {
        ...
        if (!template && templateScript.length > 0) {
          ...
          template = /\<script type="text\/template7"\>(.*)<\/script>/.exec(
            template
          )[1]
        }
        ...
        if (
          !template &&
          !vlParams.renderItem &&
          !vlParams.itemTemplate &&
          !vlParams.renderExternal
        ) {
          return
        }
        if (template) {
        ...
        self.f7VirtualList = f7.virtualList.create(
          Utils.extend(
            {
              el: self.$el,
  ...
  let f7LoginScreenTitle = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'login-screen-title', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let LoginScreenProps = Utils.extend(
    {
      opened: Boolean
    },
    Mixins.colorProps
    ...
    render: function () {
      ...
      return _c(
        ...
        [
          _vm._t('start'),
          _vm._v(' '),
          _vm.avatar || _vm.$slots.avatar
            ? _c('div', {
                staticClass: 'message-avatar',
                style: {
                  'background-image': _vm.avatar && 'url(' + _vm.avatar + ')'
                },
          ...
          _c(
            ...
            [
              _vm._t('content-start'),
              _vm._v(' '),
              _vm.name || _vm.$slots.name
                ? _c(
                    'div',
                    {
                      staticClass: 'message-name',
                      on: { click: _vm.onNameClick }
                    },
              ...
              _c(
                'div',
                {
                  ...
                  on: { click: _vm.onBubbleClick }
                },
                [
                  _vm._t('bubble-start'),
                  _vm._v(' '),
                  _vm.image || _vm.$slots.image
                    ? _c(
                        'div',
                    ...
                    : _vm._e(),
                  _vm._v(' '),
                  _vm.textHeader || _vm.$slots['text-header']
                    ? _c(
                        'div',
                        { staticClass: 'message-text-header' },
                        [
                          _vm._t('text-header', [
                            _vm._v(_vm._s(_vm.textHeader))
                          ])
                        ],
                        2
                      )
                    : _vm._e(),
                  _vm._v(' '),
                  _vm.text || _vm.$slots.text || _vm.typing
                    ? _c(
                        'div',
                        {
                          staticClass: 'message-text',
                          on: { click: _vm.onTextClick }
                        },
                        [
                          ...
                          _vm.typing
                            ? _c(
                                'div',
                                { staticClass: 'message-typing-indicator' },
                                [
                                  _c('div'),
                                  _vm._v(' '),
                                  _c('div'),
                    ...
                    : _vm._e(),
                  _vm._v(' '),
                  _vm.textFooter || _vm.$slots['text-footer']
                    ? _c(
                        'div',
                        { staticClass: 'message-text-footer' },
                        [
                          _vm._t('text-footer', [
                            _vm._v(_vm._s(_vm.textFooter))
                          ])
                        ],
                        2
                      )
  ...
  let MessagebarAttachmentProps = Utils.extend(
    {
      image: String,
      deletable: {
        type: Boolean,
  ...
  let f7MessagebarAttachment = {
    render: function () {
      ...
      return _c(
        'div',
        {
          staticClass: 'messagebar-attachment',
          class: _vm.classes,
          on: { click: _vm.onClick }
        },
        [
          ...
          _vm.deletable
            ? _c('span', {
                staticClass: 'messagebar-attachment-delete',
  ...
  let f7MessagebarAttachments = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'messagebar-attachments', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let MessagebarSheetItemProps = Utils.extend(
    {
      image: String,
      checked: Boolean
    },
  ...
  let f7MessagebarSheetImage = {
    render: function () {
      ...
      return _c(
        'label',
        {
          staticClass: 'messagebar-sheet-image checkbox',
          class: _vm.classes,
          style: { 'background-image': _vm.image && 'url(' + _vm.image + ')' }
        },
        [
          _c('input', {
            attrs: { type: 'checkbox' },
  ...
  let f7MessagebarSheetItem = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'messagebar-sheet-item', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let f7MessagebarSheet = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'messagebar-sheet', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let MessagebarProps = Utils.extend(
    {
  ...
  let f7Messagebar = {
    ...
    render: function render(c) {
      ...
      var linkEl
      if (
        (self.sendLink && self.sendLink.length > 0) ||
        self.$slots['send-link']
      ) {
        linkEl = c(
          'f7-link',
          {
      ...
      var areaEl = c(
        ...
        [beforeAreaEls, inputEl, afterAreaEls]
      )
      ...
      var innerEl = c(
        ...
        [innerStartEls, areaEl, innerEndEls]
      )
      ...
      return c(
        ...
        [beforeInnerEls, innerEl, afterInnerEls]
      )
    },
  ...
  let f7MessagesTitle = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'messages-title', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let MessagesProps = Utils.extend(
    {
      autoLayout: {
        type: Boolean,
        default: false
  ...
  let f7NavLeft = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'left', class: _vm.classes },
        [
          _vm.backLink
            ? _c('f7-link', {
                class: {
                  'icon-only':
                    _vm.backLink === true || (_vm.backLink && _vm.$theme.md)
                },
                attrs: {
                  ...
                  icon: 'icon-back',
                  text:
                    _vm.backLink !== true && !_vm.$theme.md
                      ? _vm.backLink
                      : undefined,
                  force: _vm.backLinkForce || undefined
                },
  ...
  let NavRightProps = Utils.extend(
    {
      sliding: Boolean
    },
    Mixins.colorProps
  ...
  let f7NavRight = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'right', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let NavTitleProps = Utils.extend(
    {
      title: String,
      subtitle: String,
      sliding: Boolean
  ...
  let f7NavTitle = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'title', class: _vm.classes },
        [
          _vm._t('default', [
  ...
  let f7Navbar = {
      ...
      if (self.inner) {
        ...
        innerEl = c(
          'div',
          {
            ...
            class: { sliding: self.sliding }
          },
          [leftEl, titleEl, self.$slots.default]
        )
      }
      return c(
        'div',
    ...
    mounted: function () {
      /* 此逻辑是处理ios下顶部状态栏遮挡导航栏内容的问题 */
      var _parent = this.$parent
      if (
        _parent &&
        typeof _parent.getDevicePlatform == 'function' &&
        _parent.getDevicePlatform() === 'iOS' &&
        typeof _parent.getTopSize == 'function' &&
        typeof _parent.isWeiXinDevice == 'function' &&
        !_parent.isWeiXinDevice()
      ) {
        var _top = _parent.getTopSize()
        if (typeof _top == 'number' && Number(_top) < 20) {
          $(this.$el).addClass('toone-v3-ios-navbar-fix')
        }
      }
    },
    methods: {
  ...
  let PageContentProps = Utils.extend(
    {
      tab: Boolean,
      tabActive: Boolean,
      ptr: Boolean,
  ...
  let f7PageContent = {
    ...
    render: function render(c) {
      ...
      if (self.infinite && self.infinitePreloader) {
        infiniteEl = c('div', {
          staticClass: 'preloader infinite-scroll-preloader'
        })
      }
      return c(
        'div',
        ...
        self.infiniteTop
          ? [ptrEl, infiniteEl, self.$slots.default]
          : [ptrEl, self.$slots.default, infiniteEl]
      )
    },
    ...
    mounted: function () {
      ...
      if (
        ...
        var _top = _parent.getTopSize()
        if (typeof _top == 'number' && Number(_top) < 20) {
          $(this.$el).addClass('toone-v3-ios-page-content-fix')
        }
      }
    },
    methods: {
  ...
  let f7Page = {
    ...
    render: function render(c) {
      ...
      var fixedTags =
        'navbar toolbar tabbar subnavbar searchbar messagebar fab list-index'.split(
          ' '
        )
      ...
      if (self.$slots.default) {
        for (var i = 0; i < self.$slots.default.length; i += 1) {
          ...
          if (
            typeof withMessages === 'undefined' &&
            tag.indexOf('messages') >= 0
          ) {
            withMessages = true
          }
      ...
      if (withSubnavbar) {
        self.classes['page-with-subnavbar'] = true
      }
    ...
    methods: {
      ...
      getTopSize: function getTopSize() {
        var offset = this.getOffset()
        return offset.top
      },
      isWeiXinDevice: function () {
    ...
    render: function () {
      ...
      return _c(
        'div',
        {
          ...
          class: _vm.classes,
          on: {
            'panel:open': _vm.onOpen,
            'panel:opened': _vm.onOpened,
            'panel:close': _vm.onClose,
            'panel:closed': _vm.onClosed,
            'panel:backdrop-click': _vm.onBackdropClick,
            'panel:swipe': _vm.onPanelSwipe,
            'panel:swipeopen': _vm.onPanelSwipeOpen,
            'panel:breakpoint': _vm.onBreakpoint
          }
        },
        [_vm._t('default')],
        2
  ...
  let f7Popover = {
    ...
    methods: {
      ...
      onF7Ready: function onF7Ready() {
        ...
        if (self.target) {
          popoverParams.targetEl = self.target
        }
  ...
  let PreloaderProps = Utils.extend(
    {
      size: [Number, String]
    },
    Mixins.colorProps
  ...
  let f7Preloader = {
    render: function () {
      ...
      return _c(
        'span',
        {
          ...
          class: _vm.classes,
          style: {
            width: _vm.sizeComputed ? _vm.sizeComputed + 'px' : '',
            height: _vm.sizeComputed ? _vm.sizeComputed + 'px' : ''
          }
        },
        [
          _vm.$theme.md
            ? _c('span', { staticClass: 'preloader-inner' }, [
                _c('span', { staticClass: 'preloader-inner-gap' }),
                _vm._v(' '),
                _vm._m(0),
                _vm._v(' '),
                _vm._m(1)
    ...
    staticRenderFns: [
      function () {
        ...
        var _h = _vm.$createElement
        var _c = _vm._self._c || _h
        return _c('span', { staticClass: 'preloader-inner-left' }, [
          _c('span', { staticClass: 'preloader-inner-half-circle' })
        ])
      },
      function () {
        var _vm = this
        var _h = _vm.$createElement
        var _c = _vm._self._c || _h
        return _c('span', { staticClass: 'preloader-inner-right' }, [
          _c('span', { staticClass: 'preloader-inner-half-circle' })
        ])
      }
    ],
  ...
  let ProgressbarProps = Utils.extend(
    {
      progress: Number,
      infinite: Boolean
    },
  ...
  let f7RoutableModals = {
    ...
    render: function render(c) {
      var self = this
      var modals = self.modals.map(function (modal) {
        return c(modal.component, {
          tag: 'component',
  ...
  let SearchbarProps = Utils.extend(
    {
      noShadow: Boolean,
      noHairline: Boolean,
      form: {
  ...
  let f7Searchbar = {
    ...
    render: function render(c) {
      ...
      var inputWrapEl = c('div', { staticClass: 'searchbar-input-wrap' }, [
        self.$slots['input-wrap-start'],
        inputEl,
        iconEl,
        clearEl,
        self.$slots['input-wrap-end']
      ])
  ...
  let SegmentedProps = Utils.extend(
    {
      raised: Boolean,
      round: Boolean,
      tag: {
  ...
  let f7Sheet = {
    ...
    render: function render(c) {
      ...
      var staticList = []
      var fixedTags =
        'navbar toolbar tabbar subnavbar searchbar messagebar fab'.split(' ')
    ...
    methods: {
      ...
      onF7Ready: function onF7Ready() {
        ...
        if (self.$options.propsData.backdrop === undefined) {
          var app = self.$f7
          backdrop =
            app.params.sheet && app.params.sheet.backdrop !== undefined
              ? app.params.sheet.backdrop
              : self.$theme.md
        }
  ...
  let f7Statusbar = {
    render: function () {
      ...
      var _h = _vm.$createElement
      var _c = _vm._self._c || _h
      return _c('div', { staticClass: 'statusbar', class: _vm.classes })
    },
    staticRenderFns: [],
    name: 'f7-statusbar',
    props: Mixins.colorProps,
  ...
  let f7Stepper = {
    render: function () {
      ...
      var _h = _vm.$createElement
      var _c = _vm._self._c || _h
      return _c('div', { staticClass: 'stepper', class: _vm.classes }, [
        _c('div', {
          staticClass: 'stepper-button-minus',
          on: { click: _vm.onMinusClick }
        }),
        _vm._v(' '),
        _vm.input && !_vm.buttonsOnly
          ? _c('div', { staticClass: 'stepper-input-wrap' }, [
              _c('input', {
                attrs: {
                  type: _vm.inputType,
                  min: _vm.inputType === 'number' ? _vm.min : undefined,
                  max: _vm.inputType === 'number' ? _vm.max : undefined,
                  step: _vm.inputType === 'number' ? _vm.step : undefined,
        ...
        _vm._v(' '),
        !_vm.input && !_vm.buttonsOnly
          ? _c('div', { staticClass: 'stepper-value' }, [
              _vm._v(_vm._s(_vm.value))
            ])
          : _vm._e(),
        _vm._v(' '),
        _c('div', {
          staticClass: 'stepper-button-plus',
          on: { click: _vm.onPlusClick }
        })
      ])
    },
    staticRenderFns: [],
  ...
  let SubnavbarProps = Utils.extend(
    {
      sliding: Boolean,
      title: String,
      inner: {
  ...
  let f7Subnavbar = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'subnavbar', class: _vm.classes },
        [
          _vm.inner
            ? _c(
                'div',
                { staticClass: 'subnavbar-inner' },
                [
                  _vm.title
  ...
  let SwipeoutActionsProps = Utils.extend(
    {
      left: Boolean,
      right: Boolean,
      side: String
  ...
  let f7SwipeoutActions = {
    ...
    computed: {
      classes: function classes() {
        ...
        return Utils.extend(
          ((obj = {}),
          (obj['swipeout-actions-' + this.sideComputed] = true),
          obj),
          Mixins.colorClasses(this)
        )
      },
  ...
  let SwipeoutButtonProps = Utils.extend(
    {
      text: String,
      confirmText: String,
      overswipe: Boolean,
  ...
  let f7SwipeoutButton = {
    render: function () {
      ...
      return _c(
        ...
        {
          class: _vm.classes,
          attrs: { 'data-confirm': _vm.confirmText || undefined },
          on: { click: _vm.onClick }
        },
  ...
  let f7Swiper = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'swiper-container', class: _vm.classes },
        [
          _vm._t('before-wrapper'),
          _vm._v(' '),
          _c('div', { staticClass: 'swiper-wrapper' }, [_vm._t('default')], 2),
          _vm._v(' '),
          _vm.paginationComputed === true
            ? _c('div', { staticClass: 'swiper-pagination' })
            : _vm._e(),
          _vm._v(' '),
          _vm.scrollbarComputed === true
            ? _c('div', { staticClass: 'swiper-scrollbar' })
            : _vm._e(),
          _vm._v(' '),
          _vm.navigationComputed === true
    ...
    computed: {
      ...
      paginationComputed: function paginationComputed() {
        ...
        if (
          ...
          (self.params && self.params.pagination && !self.params.pagination.el)
        ) {
          return true
        }
        return false
      ...
      scrollbarComputed: function scrollbarComputed() {
        ...
        if (
          self.scrollbar === true ||
          (self.params && self.params.scrollbar && !self.params.scrollbar.el)
        ) {
          return true
        }
        return false
      ...
      navigationComputed: function navigationComputed() {
        ...
        if (
          ...
          (self.params &&
            ...
            !self.params.navigation.nextEl &&
            !self.params.navigation.prevEl)
        ) {
          return true
        }
        return false
    ...
    methods: {
      onF7Ready: function onF7Ready(f7) {
        ...
        if (self.params) {
          Utils.extend(params, self.params)
        }
        if (self.pagination && !params.pagination.el) {
          params.pagination.el = '.swiper-pagination'
        }
        if (
          self.navigation &&
        ...
        if (self.scrollbar && !params.scrollbar.el) {
          params.scrollbar.el = '.swiper-scrollbar'
        }
  ...
  let f7Tab = {
    ...
    render: function render(c) {
      ...
      return c(
        ...
        [
          self.tabContent
            ? c(self.tabContent.component, {
                tag: 'component',
                props: self.tabContent.params,
                key: self.tabContent.id
              })
            : self.$slots.default
        ]
      )
  ...
  let f7Tabs = {
    ...
    render: function render(c) {
      ...
      if (self.animated || self.swipeable) {
        return c('div', { class: self.classes }, [tabsEl])
      }
      return tabsEl
    },
    props: TabsProps,
  ...
  let f7Toolbar = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'toolbar', class: _vm.classes },
        [
          _vm._t('before-inner'),
          _vm._v(' '),
          _vm.inner
    ...
    methods: {
      ...
      onF7Ready: function onF7Ready(f7) {
        var self = this
        if (self.tabbar) {
          f7.toolbar.setHighlight(self.$el)
        }
      }
    }
  }

  let ViewProps = Utils.extend(
    {
      tab: Boolean,
      tabActive: Boolean,
  ...
  let f7Views = {
    render: function () {
      ...
      return _c(
        'div',
        { staticClass: 'views', class: _vm.classes },
        [_vm._t('default')],
        2
      )
    },
  ...
  let vuePlugin = {
    install: function install(Vue, Framework7) {
      ...
      if (typeof Framework7 === 'undefined') {
        throw new Error(
          'Framework7 is undefined, make sure you have passed it as an argument: Vue.use(Framework7Vue, Framework7)'
        )
      }
      // Event Hub
      ...
      // Extend F7 Router
      Framework7.Router.use(VueRouter).use({
        on: {
      ...
      Vue.mixin({
        ...
        beforeCreate: function beforeCreate() {
          ...
          while (parent && !$router && !$route) {
            if (parent.$f7route) {
              $route = parent.$f7route
            }
            if (parent.$f7router) {
              $router = parent.$f7router
        ...
        beforeDestroy: function beforeDestroy() {
          var self = this
          if (self.$f7RouteChangeCallback) {
            eventHub.$off('f7RouteChange', self.$f7RouteChangeCallback)
          }
          if (self.$f7RouteChangedCallback) {
            eventHub.$off('f7RouteChanged', self.$f7RouteChangedCallback)
          }
        },
        created: function created() {
          ...
          var routeChangeCallback =
            self.onF7RouteChange ||
            self.F7RouteChange ||
            self.f7RouteChange ||
            self.f7routeChange
          var routeChangedCallback =
            self.onF7RouteChanged ||
            self.F7RouteChanged ||
            self.f7RouteChanged ||
            self.f7routeChanged
          if (!routeChangeCallback && !routeChangedCallback) {
            return
          }

          function hasRouter(router) {
            return (
              (self.$f7router && router === self.$f7router) ||
          ...
          function addRoutesCallbacks() {
            if (routeChangeCallback) {
              self.$f7RouteChangeCallback = function onRouteChange(
                to,
                from,
                router
              ) {
            ...
            if (routeChangedCallback) {
              self.$f7RouteChangedCallback = function onRouteChanged(
                to,
                from,
                router
              ) {
          ...
          if (!self.$f7) {
            eventHub.$once('f7Ready', addRoutesCallbacks)
          } else {
            addRoutesCallbacks()
          }
        },
