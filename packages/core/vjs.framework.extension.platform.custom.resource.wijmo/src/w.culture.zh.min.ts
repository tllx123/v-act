...
;(function (n) {
  n.culture = {
    ...
    MultiSelect: { itemsSelected: '选定{count:n0}个项目' },
    FlexGrid: { groupHeaderFormat: '{name}: <b>{value}</b> ({count:n0} 项目)' },
    FlexGridFilter: {
      ascending: '\u2191 升序',
      descending: '\u2193 降序',
      apply: '应用',
    ...
    olap: {
      ...
      PivotEngine: { grandTotal: '总合计', subTotal: '小计' },
      PivotPanel: {
        fields: '选择字段:',
        drag: '在下面的区域之间拖动字段:',
        filters: '过滤',
  ...
  var t = window.wijmo._updateCulture
  t && t()
})(wijmo || (wijmo = {}))
