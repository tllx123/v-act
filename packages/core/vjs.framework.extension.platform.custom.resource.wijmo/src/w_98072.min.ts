...
;(function (n) {
  ...
  function y(n, t) {
    return n == null
      ? null
      : f(t)
      ? h(n.implementsInterface) && n.implementsInterface(t)
        ? n
        : null
      : n instanceof t
      ? n
  ...
  function a(n) {
    return n != null && typeof n == 'object' && !i(n) && !o(n)
  }
  function kt(n) {
    for (var t = n, i = 0; document.getElementById(t) != null; i++) t = n + i
    return t
  }
  function dt(n) {
    if (n instanceof c) return n
    if (
      (n.touches && n.touches.length > 0 && (n = n.touches[0]),
      e(n.clientX) && e(n.clientY))
    )
      return new c(n.clientX + pageXOffset, n.clientY + pageYOffset)
  ...
  function d(t, i, r) {
    ...
    if (t != null) {
      if (f(t))
        switch (i) {
          case u.Number:
            return (o = n.Globalize.parseFloat(t, r)), isNaN(o) ? t : o
          case u.Date:
            return (
              (e = n.Globalize.parseDate(t, r)),
              e || r || !t || (e = new Date(t)),
              e && isFinite(e.getTime()) ? e : t
            )
          case u.Boolean:
      ...
      if (i == u.String) return n.Globalize.format(t, r)
    }
    return t
  }
  function ni(n, t, i) {
    ...
    return (
      i
        ? ((r = n.toString()),
          (u = r.indexOf('.')),
          u > -1 && ((r = r.substr(0, u + 1 + t)), (n = parseFloat(r))))
        : ((r = n.toFixed(t)), (n = parseFloat(r))),
      n
    )
  }
  function ti(t, i, r) {
    var u, s, o, h
    if (((t = p(t)), t.match(/\{.*"count".*:.*"when".*:.*\}/)))
      try {
        u = JSON.parse(t)
        f(u.count) &&
          ((s = i[u.count]),
          (o = u.when),
          e(s) && a(o) && ((h = o[s] || o.other), f(h) && (t = h)))
      } catch (c) {}
    return t.replace(/\{(.*?)(:(.*?))?\}/g, function (t, u, f, e) {
      var o = t
      return (
        u &&
          u[0] != '{' &&
  ...
  function g(i, r) {
    ...
    if (r)
      for (u in r)
        u[0] != '_' &&
          (t(u in i, 'Unknown property "' + u + '".'),
          (f = r[u]),
          (i._copy && i._copy(u, f)) ||
            (i[u] instanceof n.Event && h(f)
              ? i[u].addHandler(f)
              : !a(f) || f instanceof Element || !i[u] || u == 'itemsSource'
              ? (i[u] = f)
              : g(i[u], f)))
  }
  function t(n, t) {
  ...
  function p(n, i) {
    return (
      i === void 0 && (i = !0),
      t((i && n == null) || f(n), 'String expected.'),
      n
    )
  }
  function r(n, i, r) {
    if (
      (i === void 0 && (i = !1),
      r === void 0 && (r = !1),
      t((i && n == null) || e(n), 'Number expected.'),
      r && n && n < 0)
    )
  ...
  function ui(n, i, r) {
    if (
      (i === void 0 && (i = !1),
      r === void 0 && (r = !1),
      t((i && n == null) || k(n), 'Integer expected.'),
      r && n && n < 0)
    )
  ...
  function nt(n, i) {
    return (
      i === void 0 && (i = !1),
      t((i && n == null) || l(n), 'Boolean expected.'),
      n
    )
  }
  function fi(n, r) {
    ...
    return t((r && n == null) || i(n), 'Date expected.'), n
  }
  function s(n, i) {
    return (
      i === void 0 && (i = !0),
      t((i && n == null) || h(n), 'Function expected.'),
      n
    )
  }
  function ei(n, i) {
  ...
  function si(i, r) {
    ...
    var u = y(i, 'ICollectionView')
    return u != null
      ? u
      : (o(i) || t(!1, 'Array or ICollectionView expected.'),
        new n.collections.CollectionView(i))
  }
  function hi(n) {
    return n != null && n.items != null && n.items.length > 0
  }
  function ci(n) {
    return n && n.length
      ? n[0].toUpperCase() + n.substr(1).replace(/([a-z])([A-Z])/g, '$1 $2')
      : ''
  }
  function li(n) {
    return (
      f(n) &&
        (n = n.replace(/[&<>"'\/]/g, function (n) {
          return it[n]
        })),
      n
    )
  ...
  function rt(n, t) {
    if (n && t && n.setAttribute && v(n, t)) {
      var r = new RegExp('((\\s|^)' + t + '(\\s|$))', 'g'),
        i = n.getAttribute('class')
      i = i.replace(r, ' ').replace(/ +/g, ' ').trim()
  ...
  function et(n, t, i) {
    i != null ? n.setAttribute(t, i.toString()) : n.removeAttribute(t)
  }
  function ai(t, i, u) {
    if (
      (u === void 0 && (u = i),
      (t = tt(t, HTMLInputElement)),
      st(document.body, t) && !t.disabled && t.style.display != 'none')
    )
      try {
        t.setSelectionRange(r(i), r(u), n.isIE() ? null : 'backward')
        t.focus()
      } catch (f) {}
  }
  function ot() {
    var n = document.activeElement,
      t
    return (
      n && ((t = n.shadowRoot), t && t.activeElement && (n = t.activeElement)),
      n
    )
  }
  function vi(t, i) {
    for (
      var o,
        e,
        r,
        s = 'input,select,textarea,button,a,div',
        h = t.querySelectorAll(s),
        u = [],
        f = 0;
      f < h.length;
      f++
      ...
      if (
        ...
        r.offsetHeight > 0 &&
          r.tabIndex > -1 &&
          !r.disabled &&
          !w(r, '[disabled],.wj-state-disabled'))
      ) {
        if (
          n.isIE() &&
          !r.hasAttribute('tabindex') &&
          ((o = n.Control.getControl(w(r, '.wj-flexgrid'))),
          o && o.keyActionTab == 0)
        )
          continue
        ;(n.Control.getControl(r) || !r.querySelector(s)) && u.push(r)
      }
    e = 0
    i && ((f = u.indexOf(ot())), f > -1 && (e = (f + i + u.length) % u.length))
    e < u.length &&
      ((r = u[e]), r.focus(), r instanceof HTMLInputElement && r.select())
  }
  function yi(n) {
  ...
  function pi(n, t) {
    ...
    return (
      (i.innerHTML = n),
      (r = i.removeChild(i.firstChild)),
      t instanceof HTMLElement ? t.appendChild(r) : r
    )
  }
  function wi(n, t) {
    if (t == null) {
  ...
  function bi(n, t) {
    var f = !t,
      ...
      u
    for (
      ft(n, 'wj-state-disabled', f),
        et(n, 'disabled', f ? 'true' : null),
      ...
      (u = r[i]),
        t ? u.removeAttribute('disabled') : u.setAttribute('disabled', 'true')
  }
  function ki(n) {
    var t = n.getBoundingClientRect()
    return new b(t.left + pageXOffset, t.top + pageYOffset, t.width, t.height)
  }
  function ht(n, t) {
    var u, f, r, i
    if (n instanceof Array) {
      for (u = 0; u < n.length; u++) ht(n[u], t)
      return
    }
    if (n && n.style) {
      f = n.style
      for (r in t)
        (i = t[r]),
          typeof i == 'number' &&
            r.match(
              /width|height|left|top|right|bottom|size|padding|margin'/i
            ) &&
            (i = i + 'px'),
          f[r] != i && (f[r] = i.toString())
    }
  }
  function di(n, t, i) {
    t === void 0 && (t = 400)
  ...
  function gi(n, t) {
    var o, c, e, w, r, l, v
    t || (t = {})
    var y = t.method ? p(t.method).toUpperCase() : 'GET',
      b = t.async != null ? nt(t.async) : !0,
      u = t.data
    if (u != null && y == 'GET') {
      o = []
      for (c in u) (e = u[c]), i(e) && (e = e.toJSON()), o.push(c + '=' + e)
      o.length && ((w = n.indexOf('?') < 0 ? '?' : '&'), (n += w + o.join('&')))
      u = null
    }
    if (
      ...
      (r.URL_DEBUG = n),
      (l = !1),
      u == null || f(u) || ((l = a(u)), (u = JSON.stringify(u))),
      (r.onload = function () {
        r.readyState == 4 &&
          (r.status < 300
            ? t.success && s(t.success)(r)
            : t.error && s(t.error)(r),
          t.complete && s(t.complete)(r))
      }),
      (r.onerror = function () {
        if (t.error) s(t.error)(r)
        else throw 'HttpRequest Error: ' + r.status + ' ' + r.statusText
      }),
      r.open(y, n, b, t.user, t.password),
      t.user &&
        t.password &&
        r.setRequestHeader(
          'Authorization',
          'Basic ' + btoa(t.user + ':' + t.password)
        ),
      l && r.setRequestHeader('Content-Type', 'application/json'),
      t.requestHeaders)
    )
      for (v in t.requestHeaders) r.setRequestHeader(v, t.requestHeaders[v])
    return h(t.beforeSend) && t.beforeSend(r), r.send(u), r
  }
  var at = '5.20172.334',
    yt,
    u,
  ...
  ;(n.getVersion = vt),
    ...
    (function (n) {
      ...
      n[(n.Date = 4)] = 'Date'
      n[(n.Array = 5)] = 'Array'
    })((u = n.DataType || (n.DataType = {})))
  n.tryCast = y
  n.isPrimitive = pt
  n.isString = f
  n.isNullOrWhiteSpace = wt
  n.isNumber = e
  n.isInt = k
  n.isBoolean = l
  n.isFunction = h
  ...
  n.toggleClass = ft
  n.setAttribute = et
  n.setSelectionRange = ai
  n.getActiveElement = ot
  n.moveFocus = vi
  n.getElement = yi
  n.createElement = pi
  n.setText = wi
  ...
  ct = (function () {
    ...
    return (
      (n.prototype.equals = function (t) {
        return (
          t instanceof n && this.width == t.width && this.height == t.height
        )
      }),
      (n.prototype.clone = function () {
  ...
  b = (function () {
    ...
    return (
      ...
      (n.intersection = function (t, i) {
        var r = Math.max(t.left, i.left),
          u = Math.max(t.top, i.top),
          f = Math.min(t.right, i.right),
          e = Math.min(t.bottom, i.bottom)
        return new n(r, u, f - r, e - u)
      }),
  ...
  lt = (function () {
    function t() {}
    return (
      (t.addDays = function (n, i) {
        return t.newDate(n.getFullYear(), n.getMonth(), n.getDate() + i)
      }),
      (t.addMonths = function (n, i) {
        return t.newDate(n.getFullYear(), n.getMonth() + i, n.getDate())
      }),
      (t.addYears = function (n, i) {
        return t.newDate(n.getFullYear() + i, n.getMonth(), n.getDate())
      }),
      (t.addHours = function (n, i) {
        return t.newDate(
          n.getFullYear(),
          n.getMonth(),
          n.getDate(),
      ...
      (t.equals = function (n, t) {
        return i(n) && i(t) && n.getTime() == t.getTime()
      }),
      (t.fromDateTime = function (n, i) {
        return !n && !i
          ? null
          : (n || (n = i),
            i || (i = n),
      ...
      (t.toFiscal = function (i, r) {
        ...
        return o(u.fiscalYearOffsets)
          ? t.addMonths(i, -u.fiscalYearOffsets[r ? 0 : 1])
          : i
      }),
      ...
      (t.newDate = function (n, t, i, r, u, f, e) {
        var s, o, h
        return (
          (n == null || t == null || i == null) &&
            ((s = new Date()),
            n == null && (n = s.getFullYear()),
            t == null && (t = s.getMonth()),
            i == null && (i = s.getDate())),
          r == null && (r = 0),
          u == null && (u = 0),
          ...
          (h = o.getFullYear()),
          n < 100 && h >= 1900 && o.setFullYear(o.getFullYear() - 1900),
          o
        )
      }),
      (t.clone = function (n) {
  ...
  (function (n) {
    'use strict'
    function i() {
      n.culture = window.wijmo.culture
    }
    n.culture = window.wijmo.culture || {
      Globalize: {
        numberFormat: {
    ...
    var t = (function () {
      ...
      return (
        (t.format = function (i, r, u, f, _grid) {
          return n.isString(i)
            ? i
            : n.isNumber(i)
            ? ((r =
                r ||
                (_grid && typeof _grid._$getFormat == 'function'
                  ? _grid._$getFormat(i)
                  : i == Math.round(i)
                  ? 'n0'
                  : 'n2')),
              t.formatNumber(i, r, u, f))
            : n.isDate(i)
            ? ((r = r || 'd'), t.formatDate(i, r))
            : i != null
            ? i.toString()
            : ''
        }),
        (t.formatNumber = function (i, r, u, f, _grid) {
          var l, p, a
          i = n.asNumber(i)
          r =
            _grid && typeof _grid._$getFormat == 'function' && null == r
              ? _grid._$getFormat(i)
              : (r = n.asString(r))
          var h = n.culture.Globalize.numberFormat,
            s = r ? r.match(/([a-z])(\d*)(,*)(.*)/i) : null,
            o = s ? s[1].toLowerCase() : 'n',
            c =
              s && s[2]
                ? parseInt(s[2])
                : o == 'c'
                ...
                ? 0
                : 2,
            w = s && s[3] ? 3 * s[3].length : 0,
            b = s && s[4] ? s[4] : h.currency.symbol,
            v = h['.'],
            y = h[','],
            e
          if ((w && (i /= Math.pow(10, w)), o == 'd' || o == 'x')) {
            for (
              e = Math.round(Math.abs(i)).toString(o == 'd' ? 10 : 16);
              e.length < c;
            ...
            return (
              i < 0 && (e = '-' + e),
              r && r[0] == 'X' && (e = e.toUpperCase()),
              e
            )
          }
          return (
            o == 'p' && ((i = t._mul100(i)), (i = n.toFixed(i, c, f))),
            f && o != 'p' && (i = n.toFixed(i, c, !0)),
            (e =
              _grid && typeof _grid._$hP == 'function'
                ? _grid._$hP(i, c, o == 'c' || o == 'p')
                : o == 'c' || o == 'p'
                ? Math.abs(i).toFixed(c)
                : i.toFixed(c)),
            (u || o == 'g') &&
              e.indexOf('.') > -1 &&
              ((e = e.replace(/(\.[0-9]*?)0+$/g, '$1')),
              (e = e.replace(/\.$/, ''))),
            v != '.' && (e = e.replace('.', v)),
            y &&
              (o == 'n' || o == 'c' || o == 'p') &&
              ...
              (e =
                l > -1
                  ? e.substr(0, l).replace(p, y) + e.substr(l)
                  : e.replace(p, y))),
            o == 'c' &&
              ((a = h.currency.pattern[i < 0 ? 0 : 1]),
              (e = a.replace('n', e).replace('$', b))),
            o == 'p' &&
              ((a = h.percent.pattern[i < 0 ? 0 : 1]), (e = a.replace('n', e))),
            e
          )
        }),
        (t.formatDate = function (i, r) {
          ...
          for (
            r = t._expandFormat(r), f = t._parseDateFormat(r), e = '', u = 0;
            u < f.length;
            u++
          )
            e += t._formatDatePart(i, r, f[u])
          return e
        }),
        ...
        (t.parseFloat = function (t, i) {
          var r =
              ...
              (t.indexOf('(') > -1 && t.indexOf(')') > -1)
                ? -1
                : 1,
            u = t.indexOf('%') > -1 ? 0.01 : 1,
            f = i ? i.match(/,+/) : null,
            e = f ? f[0].length * 3 : 0
          if (i && (i[0] == 'x' || i[0] == 'X'))
            return (
              (t = t.replace(/[^0-9a-f]+.*$/gi, '')),
              parseInt(t, 16) * r * u * Math.pow(10, e)
            )
        ...
        (t.parseDate = function (i, r) {
            ...
            return (
              ...
              h[1] || h[5]
                ? ((e = h[1]
                    ...
                    : new Date()),
                  h[5] &&
                    (e.setHours(parseInt(h[6])),
                    e.setMinutes(parseInt(h[7])),
                    e.setSeconds(h[8] ? parseInt(h[9]) : 0)))
                : (e = new Date(i)),
              isNaN(e.getTime()) ? null : e
            )
          r = t._expandFormat(r ? r : 'd')
          var s = n.culture.Globalize.calendar,
            ft = t._CJK,
            at = new RegExp(
              '(\\' +
                s['/'] +
            ...
            ht,
            rt
          if (!c || !c.length || !p || !p.length) return null
          for (v = 0; v < p.length && c; v++) {
            var y = v - w,
              u = y > -1 && y < c.length ? c[y] : '',
              f = p[v].length
            switch (p[v]) {
              case 'EEEE':
              case 'EEE':
              ...
              case 'y':
                f > 1 &&
                  u.length > f &&
                  ((c[y] = u.substr(f)), (u = u.substr(0, f)), w++)
                l = parseInt(u)
                ht = p[v] == 'yyyy'
                break
              case 'MMMM':
              case 'MMM':
                for (
                  g = !0, ct = u.toLowerCase(), a = -1, nt = 0;
                  nt < 12;
                  nt++
                )
                  if (s.months[nt].toLowerCase().indexOf(ct) == 0) {
                    a = nt
                    break
                  }
                if (a > -1) break
              ...
              case 't':
                u = u.toUpperCase()
                ;((s.pm[0] && u == s.pm[0] && o < 12) ||
                  (s.pm[1] && u == s.pm[1] && o < 12)) &&
                  (o += 12)
                break
              case 'q':
              case 'Q':
              ...
              case 'gg':
              case 'g':
                tt = s.eras.length > 1 ? t._getEra(u, s) : -1
                break
              case s['/']:
              case s[':']:
                if (u && u != p[v]) return null
                break
              case 'K':
                break
              default:
          ...
          if (
            (g &&
              it &&
              (isNaN(o) && (o = 0), isNaN(b) && (b = 0), isNaN(k) && (k = 0)),
            a < 0 ||
              a > 11 ||
              isNaN(a) ||
              d < 0 ||
          ...
          return ot && !it
            ...
            : st && !g
            ? null
            : (l < 0 && (l = new Date().getFullYear()),
              tt > -1
                ? (l = l + s.eras[tt].start.getFullYear() - 1)
                : l < 100 &&
                  !ht &&
                  ((lt = n.isNumber(s.twoDigitYearMax)
                    ? s.twoDigitYearMax
                    : 2029),
                  (l += l + 2e3 < lt ? 2e3 : 1900)),
              (e = n.DateTime.newDate(l, a, d, o, b + 0, k, et)),
              isNaN(e.getTime()) ? null : e)
        }),
        ...
        (t._parseDateFormat = function (n) {
          var u, e, i, r, f
          if (n in t._dateFormatParts) return t._dateFormatParts[n]
          for (u = [], e = '', i = 0; i > -1 && i < n.length; i++) {
            if (
              ((f = n[i]),
              (f == "'" || f == '"') && ((r = n.indexOf(f, i + 1)), r > -1))
            ) {
              u.push(n.substring(i, r + 1))
              i = r
              continue
            }
            for (r = i + 1; r < n.length; r++) if (n[r] != f) break
            u.push(n.substring(i, r))
            i = r - 1
          }
          return (t._dateFormatParts[n] = u), u
        }),
          ...
          switch (u) {
            ...
            case 'e':
              return (
                (a =
                  u[0] == 'E'
                    ? n.DateTime.toFiscal(i, !0)
                    : u[0] == 'e'
                    ? n.DateTime.toFiscal(i, !1)
                    : i),
                (l = a.getFullYear()),
                f.eras.length > 1 &&
                  r.indexOf('g') > -1 &&
                  ((o = t._getEra(i, f)),
                  o > -1 && (l = l - f.eras[o].start.getFullYear() + 1)),
                t._zeroPad(l, 4).substr(4 - u.length)
              )
            case 'MMMM':
            ...
            case 'F':
              return (
                (v = i.getMilliseconds() * Math.pow(10, e - 3)),
                u[0] == 'f' ? t._zeroPad(v, e) : v.toFixed(0)
              )
            case 'tt':
            ...
            case 'U':
              return (
                (a = n.DateTime.toFiscal(i, u == 'U')),
                (Math.floor(a.getMonth() / 3) + 1).toString()
              )
            case 'ggg':
            case 'gg':
            case 'g':
              return f.eras.length > 1 && ((o = t._getEra(i, f)), o > -1)
                ? u == 'ggg'
                  ? f.eras[o].name
                  : u == 'gg'
                  ? f.eras[o].name[0]
            ...
            case 'z':
              ...
              switch (u) {
                case 'zzz':
                  h =
                    t.format(s / 60, 'd2', !1, !0) +
                    f[':'] +
                    t.format(s % 60, 'd2', !1, !0)
                  break
                case 'zz':
                  h = t.format(s / 60, 'd2', !1, !0)
                  break
                case 'z':
                  h = t.format(s / 60, 'd', !1, !0)
              }
              return s >= 0 ? '+' + h : h
          }
          return e > 1 && u[0] == u[e - 1] && (u[0] == '"' || u[0] == "'")
            ? u.substr(1, e - 2)
            : u
        }),
        (t._getEra = function (t, i) {
          ...
          if (n.isDate(t)) {
            ...
            for (r = 0; r < i.eras.length; r++)
              if (
                i.eras[r].name &&
                (i.eras[r].name.indexOf(t) == 0 ||
                  i.eras[r].symbol.indexOf(t) == 0)
              )
                return r
          return -1
        }),
      ...
      return (
        Object.defineProperty(n.prototype, 'path', {
          ...
          set: function (n) {
            var t, i, r
            for (
              this._path = n, this._parts = n ? n.split('.') : [], t = 0;
              ...
              (i = this._parts[t]),
                (r = i.indexOf('[')),
                r > -1 &&
                  ((this._parts[t] = i.substr(0, r)),
                  this._parts.splice(++t, 0, parseInt(i.substr(r + 1))))
        ...
        (n.prototype.getValue = function (n) {
          if (n) {
            ...
            if (this._path && this._path in n) return n[this._path]
            for (var t = 0; t < this._parts.length && n; t++)
              n = n[this._parts[t]]
          }
          return n
        }),
...
;(__extends =
  ...
  (function (n) {
    ...
    var f = (function () {
      ...
      e = (function () {
        ...
        return (
          (i.prototype.addHandler = function (t, i) {
            n.asFunction(t)
          ...
          (i.prototype.raise = function (n, i) {
            var r, u
            for (
              i === void 0 && (i = t.empty), r = 0;
              r < this._handlers.length;
              r++
            )
              (u = this._handlers[r]), u.handler.call(u.self, n, i)
          }),
    ...
    r = (function (n) {
      function t(t, i, r) {
        ...
        return (u._name = t), (u._oldVal = i), (u._newVal = r), u
      }
      return (
        __extends(t, n),
  ...
  (function (n) {
    ...
    var t = (function () {
      function t(i, r, u) {
        ...
        if (
          ...
          (this._updating = 0),
          (this._fullUpdate = !1),
          (this.gotFocus = new n.Event()),
          (this.lostFocus = new n.Event()),
          t._updateWme(),
          n.assert(
            t.getControl(i) == null,
            'Element is already hosting a control.'
          ),
          (f = n.getElement(i)),
          n.assert(f != null, 'Cannot find the host element.'),
          (this._orgOuter = f.outerHTML),
          (this._orgInner = f.innerHTML),
          (this._orgTag = f.tagName),
          (f.tagName == 'INPUT' || f.tagName == 'SELECT') &&
            (f = this._replaceWithDiv(f)),
          (this._e = f),
          (f[t._CTRL_KEY] = this),
          u == !0 &&
            ((this._szCtl = new n.Size(f.offsetWidth, f.offsetHeight)),
            (l = this._handleResize.bind(this)),
            this.addEventListener(window, 'resize', l)),
          ...
          (s = this._handleDisabled.bind(this)),
          this.addEventListener(f, 'mousedown', s, !0),
          this.addEventListener(f, 'mouseup', s, !0),
          this.addEventListener(f, 'click', s, !0),
          this.addEventListener(f, 'dblclick', s, !0),
          this.addEventListener(f, 'keydown', s, !0),
          this.addEventListener(f, 'wheel', s, !0),
          t._touching == null &&
            ((t._touching = !1),
          ...
          'ontouchstart' in window
            ? (e.addEventListener('touchstart', a),
              ...
              e.addEventListener('touchleave', h))
      ...
      return (
        (t.prototype.getTemplate = function () {
          for (
            var t, n = Object.getPrototypeOf(this);
            n;
        ...
        (t.prototype.applyTemplate = function (i, r, u, f) {
          var e = this._e,
            l,
            a,
            b,
          ...
          i && n.addClass(e, i)
          l = null
          r && (l = n.createElement(r, e))
          var nt = e.querySelectorAll('input'),
            o = nt.length == 1 ? nt[0] : null,
            p = e.attributes
          if (o && p)
            for (a = 0; a < p.length; a++)
              (b = p[a].name),
                b.match(t._rxInputAtts) && o.setAttribute(b, p[a].value)
          if (o && e.id) {
            for (v = e; v.parentElement; ) v = v.parentElement
            k = v.querySelector('label[for="' + e.id + '"]')
            k instanceof HTMLLabelElement &&
              ((d = n.getUniqueId(e.id + '_input')),
              (o.id = d),
              (k.htmlFor = d))
          }
          if (
            ...
            for (s in u) {
              if (
                ((y = u[s]),
                (this[s] = l.querySelector('[wj-part="' + y + '"]')),
                this[s] == null &&
                  l.getAttribute('wj-part') == y &&
                  (this[s] = l),
                this[s] == null)
              )
                throw 'Missing template part: "' + y + '"'
              y == f &&
                ((c = 'name'),
                (h = e.attributes[c]),
                h && h.value && this[s].setAttribute(c, h.value),
                (c = 'accesskey'),
                (h = e.attributes[c]),
                h &&
                  h.value &&
                  (this[s].setAttribute(c, h.value), e.removeAttribute(c)))
            }
          return l
        }),
        (t.prototype.dispose = function () {
          for (
            var e, u, i, r, o = this._e.querySelectorAll('.wj-control'), f = 0;
            f < o.length;
            f++
          )
            (e = t.getControl(o[f])), e && e.dispose()
          this._toInv && (clearTimeout(this._toInv), (this._toInv = null))
          this.removeEventListener()
          for (i in this)
            i.length > 2 &&
              i.indexOf('on') == 0 &&
              ((r = this[i[2].toLowerCase() + i.substr(3)]),
              r instanceof n.Event && r.removeAllHandlers())
          if (
            ((u = this.collectionView),
            u instanceof n.collections.CollectionView)
          )
            for (i in u)
              (r = u[i]), r instanceof n.Event && r.removeHandler(null, this)
        ...
        (t.getControl = function (i) {
          ...
          return r ? n.asType(r[t._CTRL_KEY], t, !0) : null
        }),
        ...
        (t.prototype.containsFocus = function () {
          var r, i, f, u
          if (!this._e) return !1
          if (((r = n.getActiveElement()), n.contains(this._e, r))) return !0
          for (i = r; i; i = i.parentElement)
            if (((f = i[t._OWNR_KEY]), f && n.contains(this._e, f))) return !0
          return ((u = t.getControl(n.closest(r, '.wj-control.wj-popup'))),
          u && u.owner && n.contains(this._e, u.owner))
            ? !0
            : !1
        }),
        ...
        (t.invalidateAll = function (n) {
          var i, r
          if ((n || (n = document.body), n.children))
            for (i = 0; i < n.children.length; i++)
              t.invalidateAll(n.children[i])
          r = t.getControl(n)
          r && r.invalidate()
        }),
        ...
        Object.defineProperty(t.prototype, 'isDisabled', {
          ...
          set: function (t) {
            t = n.asBoolean(t, !0)
            t != this.isDisabled && n.enable(this._e, !t)
          },
          enumerable: !0,
          configurable: !0
        }),
        ...
        (t.prototype.addEventListener = function (n, t, i, r) {
          ...
          n &&
            ...
            this._listeners.push({ target: n, type: t, fn: i, capture: r }))
        }),
        (t.prototype.removeEventListener = function (n, t, i, r) {
          var e = 0,
            f,
            u
          if (this._listeners)
            for (f = 0; f < this._listeners.length; f++)
              (u = this._listeners[f]),
                (n == null || n == u.target) &&
                  (t == null || t == u.type) &&
                  (i == null || i == u.fn) &&
                  (r == null || r == u.capture) &&
                  (u.target.removeEventListener(u.type, u.fn, u.capture),
                  this._listeners.splice(f, 1),
                  f--,
                  e++)
          return e
        }),
        ...
        (t._updateWme = function () {
          ...
          if (
            !t._wme ||
            !t._wme.parentElement ||
            !t._wme.offsetWidth ||
            !t._wme.offsetHeight
          ) {
            r = Array(Math.round(Math.random() * 10)).join(' ')
            u = 'Powered by Wijmo ' + n.getVersion() + ' Eval'
            t._wme = n.createElement(
              '<div><a href="http://wijmo.com/products/wijmo-5/eval/' +
                r +
                '">' +
                u +
                r +
        ...
        (t.prototype._updateFocusState = function () {
          var i = this
          setTimeout(function () {
            for (var r, f, e, o, u = i._e; u; u = u.parentElement)
              (r = t.getControl(u)),
                r &&
                  ((f = r.containsFocus()),
                  f != r._focus &&
                    ((r._focus = f),
                    f ? r.onGotFocus() : r.onLostFocus(),
                    r._updateState(),
                    f ||
                      ((e = u[t._OWNR_KEY]),
                      e &&
                        ((o = t.getControl(n.closest(e, '.wj-control'))),
                        o && o._updateFocusState()))))
          })
        }),
        (t.prototype._updateState = function () {
          var t = this.hostElement,
            ...
            r
          t &&
            (n.toggleClass(t, 'wj-state-focused', this.containsFocus()),
            (i = t.querySelector('input')),
            i instanceof HTMLInputElement &&
              (n.toggleClass(t, 'wj-state-empty', i.value.length == 0),
              n.toggleClass(t, 'wj-state-readonly', i.readOnly),
              (r = i.validationMessage),
              n.toggleClass(t, 'wj-state-invalid', r && r.length > 0)))
        }),
        (t.prototype._handleTouchStart = function (n) {
          ;(n.pointerType == null || n.pointerType == 'touch') &&
            (t._touching = !0)
        }),
        ...
        (t.prototype._replaceWithDiv = function (n) {
          var r = document.createElement('div'),
            ...
            f
          for (
            n.parentElement.replaceChild(r, n),
            ...
            (f = u[i].name),
              (f.match(/id|style|class/i) || f.match(t._rxInputAtts)) &&
                r.setAttribute(f, u[i].value)
          return r
        }),
        t
      )
    ...
    t._SCRL_KEY = '$WJ-SCRL'
    t._rxInputAtts =
      /name|tabindex|autofocus|placeholder|autocomplete|minlength|maxlength|readonly|pattern/i
    n.Control = t
  })(wijmo || (wijmo = {})),
  (function (n) {
    'use strict'
    function i(i, r, u) {
      var v = 0,
        ...
        c = null,
        y = null,
        p = u ? new n.Binding(u) : null,
        a,
        f,
        o
      if (((i = n.asEnum(i, t)), i == t.CntAll)) return r.length
      for (a = 0; a < r.length; a++) {
        if (((f = r[a]), p && (f = p.getValue(f)), i == t.First)) return f
        f != null &&
          (v++,
          (h == null || f < h) && (h = f),
          (c == null || f > c) && (c = f),
          (y = f),
          n.isNumber(f) && !isNaN(f)
            ? (e++, (l += f), (s += f * f))
            : n.isBoolean(f) && (e++, f == !0 && (l++, s++)))
      }
      o = e == 0 ? 0 : l / e
      switch (i) {
        case t.Avg:
        ...
        case t.Sum:
          return l
        case t.VarPop:
          return e <= 1 ? 0 : s / e - o * o
        case t.StdPop:
          return e <= 1 ? 0 : Math.sqrt(s / e - o * o)
        case t.Var:
          return e <= 1 ? 0 : ((s / e - o * o) * e) / (e - 1)
        case t.Std:
          return e <= 1 ? 0 : Math.sqrt(((s / e - o * o) * e) / (e - 1))
        case t.Last:
          return y
      }
    ...
    ;(function (n) {
      ...
      n[(n.CntAll = 11)] = 'CntAll'
      n[(n.First = 12)] = 'First'
      n[(n.Last = 13)] = 'Last'
    })((t = n.Aggregate || (n.Aggregate = {})))
    n.getAggregate = i
  })(wijmo || (wijmo = {}))
;(__extends =
  (this && this.__extends) ||
  ...
  (function (n) {
    ...
    ;(function (t) {
      ...
      ;(function (n) {
        ...
        (r =
          t.NotifyCollectionChangedAction ||
          (t.NotifyCollectionChangedAction = {}))
      )
      i = (function (n) {
        function t(t, i, u) {
          ...
          return (f.action = t), (f.item = i), (f.index = u), f
        }
        return __extends(t, n), t
      })(n.EventArgs)
      i.reset = new i(r.Reset)
      t.NotifyCollectionChangedEventArgs = i
      f = (function () {
        function t(t, i) {
      ...
      u = (function () {
        function n() {}
        return (
          (n.prototype.groupNameFromItem = function () {
            return ''
          }),
      ...
      t.GroupDescription = u
      o = (function (t) {
        function i(i, r) {
          var u = t.call(this) || this
          return (u._bnd = new n.Binding(i)), (u._converter = r), u
        }
        return (
          __extends(i, t),
          Object.defineProperty(i.prototype, 'propertyName', {
            get: function () {
              return this._bnd.path
            },
            enumerable: !0,
          ...
          (i.prototype.groupNameFromItem = function (n) {
            return this._converter
              ? this._converter(n, this.propertyName)
              : this._bnd.getValue(n)
          }),
      ...
      r = (function (i) {
        function r(t) {
          var r = i.call(this) || this,
            u
          if (((r._updating = 0), (r.collectionChanged = new n.Event()), t)) {
            for (t = n.asArray(t), r._updating++, u = 0; u < t.length; u++)
              r.push(t[u])
            r._updating--
          }
          return r
        ...
        return (
          ...
          (r.prototype.push = function () {
            for (var f, r, n = [], u = 0; u < arguments.length; u++)
              n[u] = arguments[u]
            for (f = this.length, r = 0; n && r < n.length; r++)
              (f = i.prototype.push.call(this, n[r])),
                this._updating ||
                  this._raiseCollectionChanged(
                    t.NotifyCollectionChangedAction.Add,
                    n[r],
                    f - 1
                  )
            return f
          ...
          (r.prototype.pop = function () {
            ...
            return (
              this._raiseCollectionChanged(
                t.NotifyCollectionChangedAction.Remove,
                n,
                this.length
              ),
              n
          ...
          (r.prototype.splice = function (n, r, u) {
            var f
            return r && u
              ? ((f = i.prototype.splice.call(this, n, r, u)),
                r == 1
                  ? this._raiseCollectionChanged(
                      t.NotifyCollectionChangedAction.Change,
                      u,
                      n
                    )
                  : this._raiseCollectionChanged(),
                f)
              : u
              ? ((f = i.prototype.splice.call(this, n, 0, u)),
                this._raiseCollectionChanged(
                  t.NotifyCollectionChangedAction.Add,
                  u,
                  n
                ...
                f)
              : ((f = i.prototype.splice.call(this, n, r)),
                r == 1
                  ? this._raiseCollectionChanged(
                      t.NotifyCollectionChangedAction.Remove,
                      f[0],
    ...
    ;(function (t) {
      ...
      var r = (function () {
          function r(i, r) {
            ...
            this.sourceCollectionChanging = new n.Event()
            this.sourceCollectionChanged = new n.Event()
            ...
            this._srtDsc.collectionChanged.addHandler(function () {
              for (var r = u._srtDsc, i = 0; i < r.length; i++)
                n.assert(
                  r[i] instanceof t.SortDescription,
                  'sortDescriptions array must contain SortDescription objects.'
                )
              u.canSort && u.refresh()
            })
            this._grpDesc.collectionChanged.addHandler(function () {
              for (var r = u._grpDesc, i = 0; i < r.length; i++)
                n.assert(
                  r[i] instanceof t.GroupDescription,
                  'groupDescriptions array must contain GroupDescription objects.'
                )
              u.canGroup && u.refresh()
            })
            this.sourceCollection = i ? i : new t.ObservableArray()
            r && (this.beginUpdate(), n.copy(this, r), this.endUpdate())
          }
          return (
            (r.prototype._copy = function (i, r) {
              var e, f, u
              if (i == 'sortDescriptions') {
                for (
                  this.sortDescriptions.clear(), e = n.asArray(r), f = 0;
                  f < e.length;
                  f++
                )
                  (u = e[f]),
                    n.isString(u) && (u = new t.SortDescription(u, !0)),
                    this.sortDescriptions.push(u)
                return !0
              }
              if (i == 'groupDescriptions') {
                for (
                  this.groupDescriptions.clear(), e = n.asArray(r), f = 0;
                  f < e.length;
                  f++
                )
                  (u = e[f]),
                    n.isString(u) && (u = new t.PropertyGroupDescription(u)),
                    this.groupDescriptions.push(u)
                return !0
              }
              return !1
            }),
            Object.defineProperty(r.prototype, 'newItemCreator', {
              get: function () {
            ...
            Object.defineProperty(r.prototype, 'sortComparer', {
              get: function () {
                return this._srtCmp
              },
              set: function (t) {
                t != this._srtCmp && (this._srtCmp = n.asFunction(t, !0))
              },
              enumerable: !0,
              configurable: !0
            }),
            ...
            (r.prototype.getAggregate = function (t, i, r) {
              var u = r ? this._pgView : this._view
              return n.getAggregate(t, u, i)
            }),
            ...
            Object.defineProperty(r.prototype, 'getError', {
              get: function () {
                return this._getError
              },
              set: function (t) {
                this._getError = n.asFunction(t)
              },
              enumerable: !0,
              configurable: !0
            }),
            (r.prototype.onCollectionChanged = function (n) {
              n === void 0 && (n = t.NotifyCollectionChangedEventArgs.reset)
              n.action != t.NotifyCollectionChangedAction.Change ||
                this._committing ||
                this._canceling ||
                n.item == this.currentEditItem ||
                n.item == this.currentAddItem ||
                this._trackItemChanged(n.item)
            ...
            (r.prototype.onSourceCollectionChanging = function (n) {
              return this.sourceCollectionChanging.raise(this, n), !n.cancel
            }),
            (r.prototype.onSourceCollectionChanged = function (n) {
              this.sourceCollectionChanged.raise(this, n)
            }),
            ...
            Object.defineProperty(r.prototype, 'currentPosition', {
              ...
              set: function (t) {
                this.moveCurrentToPosition(n.asNumber(t))
              },
              enumerable: !0,
              configurable: !0
            }),
            ...
            Object.defineProperty(r.prototype, 'sourceCollection', {
              ...
              set: function (t) {
                if (t != this._src) {
                  if (!this.onSourceCollectionChanging(new n.CancelEventArgs()))
                    return
                  var i = this.currentPosition
                  this.commitEdit()
                  this.commitNew()
                  this._ncc != null &&
                    this._ncc.collectionChanged.removeHandler(
                      this._sourceChanged
                    )
                  this._src = n.asArray(t, !1)
                  this._ncc = n.tryCast(this._src, 'INotifyCollectionChanged')
                  this._ncc &&
                    this._ncc.collectionChanged.addHandler(
                      this._sourceChanged,
                      this
                    )
                  this.clearChanges()
                  this.refresh()
                  /*this.moveCurrentToFirst();*/ this.onSourceCollectionChanged()
            ...
            (r.prototype.moveCurrentToPosition = function (t) {
              ...
              return (
                t >= -1 &&
                  t < this._pgView.length &&
                  t != this._idx &&
                  ((r = new n.CancelEventArgs()),
                  this.onCurrentChanging(r) &&
                    ((i = this._pgView[t]),
                    this._edtItem && i != this._edtItem && this.commitEdit(),
                    this._newItem && i != this._newItem && this.commitNew(),
                    (this._idx = t),
            ...
            (r.prototype._performRefresh = function () {
              ...
              this._updating > 0 ||
                ...
                (this._view = this._src
                  ? this._filter && this.canFilter
                    ? this._performFilter(this._src)
                    : this._srtDsc.length > 0 && this.canSort
                    ? this._src.slice(0)
                    : this._src
                  : []),
                this.canSort &&
              ...
              return function (f, e) {
                for (var l, a, c = 0; c < i.length; c++) {
                  var h = i[c],
                    ...
                    s = h._bnd.getValue(e)
                  if (
                    (t && ((o = t(h, f, o, u)), (s = t(h, e, s, !1)), (u = !1)),
                    r && ((n = r(o, s)), n != null))
                  )
                    return h.ascending ? +n : -n
                  if (
                    (o !== o && (o = null),
                    s !== s && (s = null),
                    typeof o == 'string' &&
            ...
            (r.prototype.commitEdit = function () {
              ...
              n != null &&
                ((this._committing = !0),
                (r = this._sameContent(n, this._edtClone)),
                (this._edtItem = null),
                (this._edtClone = null),
                (i = this._pgView.indexOf(n)),
                (u = this._digest),
                this._performRefresh(),
                r || this._trackItemChanged(n),
                this._pgView.indexOf(n) == i && u == this._digest
                  ? this._raiseCollectionChanged(
                      t.NotifyCollectionChangedAction.Change,
                      n,
                      i
            ...
            (r.prototype.cancelEdit = function () {
              ...
              if (r != null) {
                ...
                if (((i = this._src.indexOf(r)), i < 0 || !this._edtClone))
                  return
            ...
            (r.prototype.addNew = function () {
              ...
              if (
                ...
                return (
                  n.assert(!1, 'cannot add items (canAddNew == false).'), null
                )
              if (
                ((i = null),
                (u = this.sourceCollection),
                (i = this.newItemCreator
                  ? this.newItemCreator()
                  : u && u.length
                  ? new u[0].constructor()
                  : {}),
                ...
                if (
                  ...
                  this._src.push(i),
                  this._updating--,
                  this._pgView != this._src && this._pgView.push(i),
                  this.groups && this.groups.length)
                )
                  for (
                    r = this.groups[this.groups.length - 1], r.items.push(i);
                    r.groups && r.groups.length;

                  )
                    (r = r.groups[r.groups.length - 1]), r.items.push(i)
                this._raiseCollectionChanged(
                  t.NotifyCollectionChangedAction.Add,
                  i,
            ...
            (r.prototype.commitNew = function () {
              ...
              n != null &&
                ...
                this._performRefresh(),
                this._trackChanges &&
                  ((r = this._chgEdited.indexOf(n)),
                  r > -1 && this._chgEdited.removeAt(r),
                  this._chgAdded.indexOf(n) < 0 && this._chgAdded.push(n)),
                this._pgView.indexOf(n) == i && u == this._digest
                  ? this._raiseCollectionChanged(
                      t.NotifyCollectionChangedAction.Change,
                      n,
            ...
            (r.prototype.remove = function (i) {
              ...
              if (
                ...
                i == this._edtItem && this.cancelEdit(),
                !this.canRemove)
              ) {
              ...
              r > -1 &&
                ((o = this.currentItem),
                this._updating++,
                this._src.splice(r, 1),
                this._updating--,
                (s = this._digest),
                this._performRefresh(),
                this._trackChanges &&
                  ((u = this._chgAdded.indexOf(i)),
                  u > -1 && this._chgAdded.removeAt(u),
                  (f = this._chgEdited.indexOf(i)),
                  f > -1 && this._chgEdited.removeAt(f),
                  (h = this._chgRemoved.indexOf(i)),
                  h < 0 && !e && u < 0 && this._chgRemoved.push(i)),
                (c = this.sortDescriptions.length > 0),
                (l = this.pageSize > 0 && this._pgIdx > -1),
                c || l || s != this._getGroupsDigest(this.groups)
                  ? this._raiseCollectionChanged()
                  : this._raiseCollectionChanged(
                      t.NotifyCollectionChangedAction.Remove,
                      i,
                ...
                this.currentItem !== o && this.onCurrentChanged())
            }),
            ...
            (r.prototype._trackItemChanged = function (n) {
              ...
              if (
                this._trackChanges &&
                ((u = this.sourceCollection), u && u.indexOf(n) > -1)
              )
                if (
                  ((i = this._chgEdited.indexOf(n)),
                  (f = t.NotifyCollectionChangedAction.Change),
                  i < 0 && this._chgAdded.indexOf(n) < 0)
                )
                  this._chgEdited.push(n)
                else if (i > -1) {
                  r = new t.NotifyCollectionChangedEventArgs(f, n, i)
            ...
            (r.prototype._sameContent = function (n, t) {
              for (var i in t) if (!this._sameValue(n[i], t[i])) return !1
              for (i in n) if (!this._sameValue(n[i], t[i])) return !1
              return !0
            }),
              ...
              return (
                r != this._pgIdx &&
                  (this.canChangePage ||
                    n.assert(
                      !1,
                      'cannot change pages (canChangePage == false).'
                    ),
                  (u = new t.PageChangingEventArgs(r)),
                  this.onPageChanging(u) &&
                    ((this._pgIdx = r),
                    (this._pgView = this._getPageView()),
                    (this._idx = 0),
                    this.groupDescriptions && this.groupDescriptions.length != 0
                      ? this.refresh()
            ...
            (r.prototype._getGroupByPath = function (n, t, i) {
              for (var r, u = 0; u < n.length; u++)
                if (
                  ((r = n[u]), r.level == t && r._path == i) ||
                  (r.level < t &&
                    i.indexOf(r._path) == 0 &&
                    ((r = this._getGroupByPath(r.groups, t, i)), r != null))
                )
                  return r
              return null
            }),
            ...
            (r.prototype._getGroupsDigest = function (n) {
              for (var t, i = '', r = 0; n != null && r < n.length; r++)
                (t = n[r]),
                  (i += '{' + t.name + ':' + (t.items ? t.items.length : '*')),
                  t.groups.length > 0 &&
                    ((i += ','), (i += this._getGroupsDigest(t.groups))),
                  (i += '}')
              return i
            }),
            (r.prototype._mergeGroupItems = function (n) {
              for (var i, f, t, r, e = [], u = 0; u < n.length; u++) {
                if (((i = n[u]), !i._isBottomLevel))
                  for (
                    f = this._mergeGroupItems(i.groups), t = 0, r = f.length;
                    t < r;
                    t++
                  )
                    i._items.push(f[t])
                for (t = 0, r = i._items.length; t < r; t++) e.push(i._items[t])
              }
              return e
            }),
            (r.prototype._getGroup = function (t, r, u, f, e, o) {
              ...
              if (u && n.isPrimitive(f)) {
                ...
                for (s = 0; s < r.length; s++)
                  if (t.namesMatch(r[s].name, f)) return r[s]
              return (h = new i(t, f, e, o)), r.push(h), u && (u[f] = h), h
            }),
            r
          )
        })(),
...
;(__extends =
  ...
  (function (n) {
    ...
    var i = (function () {
        ...
        return (
          (i.prototype.setTooltip = function (t, i) {
            t = n.getElement(t)
            i = this._getContent(i)
            var r = this._indexOf(t)
            r > -1 && (this._detach(t), this._tips.splice(r, 1))
            i && (this._attach(t), this._tips.push({ element: t, content: i }))
          }),
          (i.prototype.getTooltip = function (t) {
            var r, i
            for (t = n.getElement(t), r = this._tips, i = 0; i < r.length; i++)
              if (r[i].element == t) return r[i].content
            return null
          }),
          (i.prototype.show = function (r, u, f) {
            ...
            e = i._eTip
            e ||
              ((e = i._eTip = document.createElement('div')),
              n.addClass(e, 'wj-tooltip'),
            ...
            o.content &&
              ...
              (e.style.minWidth = ''),
              (f = new n.Rect(
                f.left - (e.offsetWidth - f.width) / 2,
                f.top - this.gap,
                e.offsetWidth,
                f.height + 2 * this.gap
              )),
              ...
              document.addEventListener('mousedown', function (n) {
                n.defaultPrevented || s._hideAutoTip()
              }))
          }),
          ...
          (i.prototype.onPopup = function (n) {
            return this.popup && this.popup.raise(this, n), !n.cancel
          }),
          ...
          (i.prototype._showAutoTip = function (t) {
            ...
            if (!t.defaultPrevented) {
              if (t.type == 'click' && !n.Control._touching) {
                this._hideAutoTip()
                return
              }
              ...
              this._toShow = setTimeout(function () {
                ...
                u > -1 &&
                  ((r = i._tips[u]),
                  (f = i._showAtMouse
                    ? new n.Rect(t.clientX, t.clientY, 0, 0)
                    : null),
                  i.show(r.element, r.content, f),
                  i._hideDelay > 0 &&
    ...
    t = (function (t) {
      function i(i) {
        ...
        return (r._content = n.asString(i)), r
      }
      return (
        __extends(i, t),
    ...
    var t = (function () {
      ...
      return (
        ...
        (t.prototype.toString = function () {
          ...
          return n > 99
            ? '#' +
                (16777216 + (this.r << 16) + (this.g << 8) + this.b)
                  .toString(16)
                  .slice(1)
            : 'rgba(' +
                this.r +
        ...
        (t.fromRgba = function (i, r, u, f) {
          ...
          var e = new t(null)
          return (
            (e.r = Math.round(n.clamp(n.asNumber(i), 0, 255))),
            (e.g = Math.round(n.clamp(n.asNumber(r), 0, 255))),
            (e.b = Math.round(n.clamp(n.asNumber(u), 0, 255))),
            (e.a = n.clamp(n.asNumber(f), 0, 1)),
            e
          )
        }),
        (t.fromHsb = function (i, r, u, f) {
          f === void 0 && (f = 1)
          var e = t._hsbToRgb(
            n.clamp(n.asNumber(i), 0, 1),
            n.clamp(n.asNumber(r), 0, 1),
            n.clamp(n.asNumber(u), 0, 1)
          )
        ...
        (t.toOpaque = function (i, r) {
          if (
            ((i = n.isString(i) ? t.fromString(i) : n.asType(i, t)), i.a == 1)
          )
            return i
          r =
            r == null
        ...
        (t.prototype._parse = function (n) {
          var u, f, r, e, i, o
          if (((n = n.toLowerCase()), n == 'transparent'))
          ...
          if (
            (n &&
              ...
              (f = u.style.color),
              f == n &&
                ((f = window.getComputedStyle(u).color),
                f ||
            ...
            return n.length == 4
              ? ((this.r = parseInt(n[1] + n[1], 16)),
                (this.g = parseInt(n[2] + n[2], 16)),
                (this.b = parseInt(n[3] + n[3], 16)),
                (this.a = 1),
                !0)
              : n.length == 7
              ? ((this.r = parseInt(n.substr(1, 2), 16)),
                (this.g = parseInt(n.substr(3, 2), 16)),
                (this.b = parseInt(n.substr(5, 2), 16)),
                (this.a = 1),
                !0)
              : !1
          if (
            ...
            r > -1 &&
              e > -1 &&
              ((i = n.substr(r + 1, e - (r + 1)).split(',')), i.length > 2))
          )
            return (
              (this.r = parseInt(i[0])),
              (this.g = parseInt(i[1])),
              (this.b = parseInt(i[2])),
              (this.a = i.length > 3 ? parseFloat(i[3]) : 1),
              !0
            )
          if (
            n.indexOf('hsl') == 0 &&
        ...
        (t._hslToRgb = function (i, r, u) {
          ...
          return (
            n.assert(
              i >= 0 && i <= 1 && r >= 0 && r <= 1 && u >= 0 && u <= 1,
              'bad HSL values'
            ),
            r == 0
              ? (o = s = h = u)
              : ((f = u < 0.5 ? u * (1 + r) : u + r - u * r),
                (e = 2 * u - f),
                (o = t._hue2rgb(e, f, i + 1 / 3)),
                (s = t._hue2rgb(e, f, i)),
                (h = t._hue2rgb(e, f, i - 1 / 3))),
            [Math.round(o * 255), Math.round(s * 255), Math.round(h * 255)]
          )
        }),
        ...
        (t._hsbToHsl = function (t, i, r) {
          ...
          return (
            n.assert(!isNaN(u) && !isNaN(e), 'bad conversion to HSL'), [t, e, u]
          )
        }),
        (t._hslToHsb = function (t, i, r) {
          ...
          var u = n.clamp(
              r == 1 ? 1 : (2 * r + i * (1 - Math.abs(2 * r - 1))) / 2,
              0,
              1
            ),
            f = n.clamp(u > 0 ? (2 * (u - r)) / u : i, 0, 1)
          return (
            n.assert(!isNaN(u) && !isNaN(f), 'bad conversion to HSB'), [t, f, u]
          )
        }),
        t
      )
  ...
  (function (n) {
    ...
    var t = (function () {
      ...
      return (
        (t.copy = function (n) {
          t._copyPasteInternal(n)
        }),
        (t.paste = function (n) {
          t._copyPasteInternal(n)
        }),
        (t._copyPasteInternal = function (t) {
          for (
            var u = n.getActiveElement(), r = n.closest(u, '.wj-control'), i;
            r && n.Control.getControl(r);
          ...
          r &&
            ...
            (i.style.opacity = '0'),
            r.appendChild(i),
            typeof t == 'string' && (i.value = t),
            i.select(),
            (i.onkeydown = function (n) {
              i.value && n.preventDefault()
            }),
            setTimeout(function () {
              u.focus()
              var n = i.value
  ...
  (function (n) {
    ...
    function i(i, r, u, f, e) {
      var c, v, l, ut, y, ft, g, nt, p, b, tt, et, w, it, rt
      if (
        (r === void 0 && (r = null),
        u === void 0 && (u = !1),
        f === void 0 && (f = !1),
        ...
        for (v = r; v; v = v.parentElement)
          if (getComputedStyle(v).position == 'fixed') {
            c = v
            break
          }
      }
      ;(i.offsetHeight && i.offsetWidth && n.contains(c, i)) ||
        (c.lastChild != i && c.appendChild(i))
      r instanceof HTMLElement &&
        e &&
        ((l = getComputedStyle(r)),
        (ut = new n.Color(l.backgroundColor)),
        ut.a &&
          n.setCss(i, {
            color: l.color,
      ...
      n.setCss(i, { position: 'absolute', visibility: 'hidden', display: '' })
      n.Control.refreshAll(i)
      var a = getComputedStyle(i),
        ot = parseFloat(a.marginTop) + parseFloat(a.marginBottom),
        st = parseFloat(a.marginLeft) + parseFloat(a.marginRight),
        h = new n.Size(i.offsetWidth + st, i.offsetHeight + ot),
        o = new n.Point(),
        s = null
      if (
        r &&
        ...
        r.clientX <= 0 && r.clientY <= 0 && r.target
          ? (s = r.target.getBoundingClientRect())
          : ((o.x = Math.max(0, r.pageX - pageXOffset)),
            (o.y = Math.max(0, r.pageY - pageYOffset)))
      else if (r instanceof n.Point) o = r
      else if (r instanceof HTMLElement) s = r.getBoundingClientRect()
      else if (r && r.top != null && r.left != null) s = r
      else if (r == null)
        (o.x = Math.max(0, (innerWidth - h.width) / 2)),
          (o.y = Math.max(0, Math.round(((innerHeight - h.height) / 2) * 0.7)))
      else throw 'Invalid ref parameter.'
      if (((y = parseFloat(a.minWidth)), s)) {
        var k = s.top,
          d = innerHeight - s.bottom,
          ht = getComputedStyle(i).direction == 'rtl'
        o.x = ht
          ? Math.max(0, s.right - h.width)
          : Math.max(0, Math.min(s.left, innerWidth - h.width))
        o.y = u
          ? k > h.height || k > d
            ? Math.max(0, s.top - h.height)
            : s.bottom
          : d > h.height || d > k
          ? s.bottom
          : Math.max(0, s.top - h.height)
        y = Math.max(y, s.width)
        n.isIE() &&
          ((ft =
            i.offsetWidth -
            (i.clientWidth +
        ...
        (g = innerHeight - 20),
          o.y + h.height > g && (o.y = Math.max(0, g - h.height)),
          (nt = innerWidth - 20),
          o.x + h.width > nt && (o.x = Math.max(0, nt - h.width))
      p = new n.Point(0, 0)
      r &&
        c &&
        (c == document.body
          ? ((b = document.documentElement.clientHeight / window.innerHeight),
            b > 1.0001
              ? (r.clientX != null &&
                  ...
                  r.pageX != null &&
                  r.pageY != null &&
                  ((o.x = r.clientX), (o.y = r.clientY)),
                (r = null))
              : (p = new n.Point(pageXOffset / b, pageYOffset / b)))
          : ((tt = c.getBoundingClientRect()),
            (p = new n.Point(c.scrollLeft - tt.left, c.scrollTop - tt.top))))
      et = {
      ...
      f &&
        ((i.style.opacity = '0'),
        n.animate(function (n) {
          i.style.opacity = n == 1 ? '' : n.toString()
        }))
      r instanceof HTMLElement && (i[n.Control._OWNR_KEY] = r)
      n.setCss(i, et)
      w = r instanceof MouseEvent ? r.target : r
      w instanceof HTMLElement &&
        ((it = w.getBoundingClientRect()),
        (rt = new n.Control(document.createElement('div'))),
        (i[n.Control._SCRL_KEY] = rt),
        rt.addEventListener(
          document,
          'scroll',
          function (r) {
            if (r.target != document && n.contains(document, w)) {
              var u = w.getBoundingClientRect(),
                f = Math.abs(u.left - it.left),
                e = Math.abs(u.top - it.top)
              ;(f > 1 || e > 1) && t(i, !0)
            }
          },
          !0
    ...
    function t(t, i) {
      ...
      var r = t[n.Control._SCRL_KEY]
      r instanceof n.Control && r.dispose()
      delete t[n.Control._SCRL_KEY]
      delete t[n.Control._OWNR_KEY]
    }
    n.showPopup = i
    n.hidePopup = r
  })(wijmo || (wijmo = {})),
      ...
      return (
        ...
        (t.prototype.append = function (t) {
          ...
          n.isString(t)
            ...
            ? i.write(t.outerHTML)
            : n.assert(!1, 'child should be an HTML element or a string.')
        }),
        (t.prototype.print = function () {
          ...
          this._iframe &&
            (this._close(),
            setTimeout(function () {
              var i = t._iframe.contentWindow,
                r = 'onafterprint' in i && !n.isFirefox()
              r &&
                (i.onafterprint = function () {
                  document.body.removeChild(t._iframe)
                  t._iframe = null
                })
              i.focus()
              i.print()
              r || (document.body.removeChild(t._iframe), (t._iframe = null))
            }, 100))
        }),
        ...
        (t.prototype._close = function () {
          ...
          if (
            (i.close(),
            this.title &&
              ((r = i.querySelector('title')),
              r || ((r = i.createElement('title')), i.head.appendChild(r)),
              (r.textContent = this.title)),
            this._copyCss)
          ) {
            for (
              e = document.head.querySelectorAll('LINK'), t = 0;
              t < e.length;
              t++
            )
              (u = e[t]),
                u.href.match(/\.css$/i) &&
                  u.rel.match(/stylesheet/i) &&
                  ((f = n.httpRequest(u.href, { async: !1 })),
                  this._addStyle(f.responseText))
            for (
              o = document.head.querySelectorAll('STYLE'), t = 0;
              t < o.length;
              t++
            )
              this._addStyle(o[t].textContent)
          }
          if (this._css)
            for (t = 0; t < this._css.length; t++)
              (s = i.createElement('style')),
                (f = n.httpRequest(this._css[t], { async: !1 })),
  ...
  (function (n) {
    ...
    var i = (function () {
        ...
        return (
          Object.defineProperty(i.prototype, 'input', {
            get: function () {
              return this._tbx
            },
            set: function (n) {
          ...
          Object.defineProperty(i.prototype, 'promptChar', {
            ...
            set: function (t) {
              t != this._promptChar &&
                ((this._promptChar = n.asString(t, !1)),
                n.assert(
                  this._promptChar.length == 1,
          ...
          (i.prototype.getRawValue = function () {
            ...
            for (n = 0; n < this._mskArr.length && n < t.length; n++)
              this._mskArr[n].literal || t[n] == this._promptChar || (i += t[n])
            return i
          }),
          ...
          (i.prototype._keydown = function (t) {
            if (t.keyCode == n.Key.Back) {
              var i = this._tbx.selectionStart,
                r = this._tbx.selectionEnd
              if (i <= this._firstPos && r == i) {
                t.preventDefault()
                this._backSpace = !1
                return
              }
          ...
          (i.prototype._preventKey = function (t) {
            ...
            if (t && this._mskArr.length) {
              ...
              if (
                (i < this._firstPos &&
                  ((i = this._firstPos), n.setSelectionRange(u, i)),
                i >= this._mskArr.length)
              )
                return !0
              if (((r = this._mskArr[i]), r.literal)) this._validatePosition(i)
              else if (r.wildCard != f && !this._isCharValid(r.wildCard, f))
                return !0
            }
            return !1
          }),
            ...
            t &&
              (n
                ? ((this._autoComplete = t.autocomplete),
                  ...
                  (t.autocomplete = 'off'),
                  (t.spellcheck = !1),
                  t.addEventListener('input', this._hbInput),
                  t.addEventListener('keydown', this._hbKeyDown, !0),
                  t.addEventListener('keypress', this._hbKeyPress, !0),
                  t.addEventListener(
                    'compositionstart',
                  ...
                  t.addEventListener(
                    'compositionend',
                    this._hbCompositionEnd,
                    !0
                  ),
                  t.addEventListener('blur', this._hbCompositionEnd, !0),
                  this._valueChanged())
                : ((t.autocomplete = this._autoComplete),
                  (t.spellcheck = this._spellCheck),
                  t.removeEventListener('input', this._hbInput),
                  t.removeEventListener('keydown', this._hbKeyDown, !0),
                  t.removeEventListener('keypress', this._hbKeyPress, !0),
                  ...
                  t.removeEventListener('blur', this._hbCompositionEnd, !0)))
          }),
          (i.prototype._valueChanged = function () {
            ...
            if (this._tbx && this._msk) {
              var t = this._tbx,
                ...
                n = t.selectionStart,
                u = n > 0 ? t.value[n - 1] : ''
              t.value = this._applyMask()
              r && (n = this._firstPos + 1)
              i = n > 0 ? t.value[n - 1] : ''
              n > 0 && i == this._promptChar && u != this.promptChar && n--
          ...
          (i.prototype._applyMask = function () {
            var t, e, r, f, u, n, i
            if (
              ((this._full = !0), (t = this._tbx.value), !this._msk) ||
              (!t && !this._tbx.required)
            )
              return t
            for (
              e = '', r = 0, t = this._handleVagueLiterals(t), f = 0;
              f < this._mskArr.length;
              f++
            ) {
              if (
                ((u = this._mskArr[f]),
                ...
                if (((n = this._promptChar), t)) {
                  for (i = r; i < t.length; i++)
                    if (this._isCharValid(u.wildCard, t[i])) {
                      n = t[i]
                      switch (u.charCase) {
                        case '>':
                          n = n.toUpperCase()
          ...
          (i.prototype._handleVagueLiterals = function (n) {
            ...
            if (
              ((i = n.length - this._mskArr.length), i != 0 && n.length > 1)
            ) {
              for (
                t = -1, f = Math.max(0, this._tbx.selectionStart - i), r = f;
              ...
              if (t > -1)
                if (i < 0)
                  (e = Array(1 - i).join(this._promptChar)),
                    (u = t + i),
                    u > -1 && (n = n.substr(0, u) + e + n.substr(u))
                else {
          ...
          (i.prototype._isCharValid = function (n, t) {
            ...
            switch (n) {
              ...
              case '\uff2a':
              case '\uff27':
                return n == '\uff27' && i._X_DBCS_BIG_HIRA.indexOf(t) > -1
                  ? !1
                  : (t >= '\u3041' && t <= '\u3096') || t == r
              case '\uff2b':
              case '\uff2e':
                return n == '\uff2e' && i._X_DBCS_BIG_KATA.indexOf(t) > -1
                  ? !1
                  : (t >= '\u30a1' && t <= '\u30fa') || t == r
              case '\uff3a':
                return t <= '\u0021' || t >= '\u00ff' || t == r
              ...
              case 'K':
              case 'N':
                return n == 'N' && i._X_SBCS_BIG_KATA.indexOf(t) > -1
                  ? !1
                  : (t >= '\uff66' && t <= '\uff9f') || t == r
            }
            return !1
          ...
          (i.prototype._validatePosition = function (t) {
            ...
            n.getActiveElement() == this._tbx &&
              n.setSelectionRange(this._tbx, t)
            this._backSpace = !1
          }),
            ...
            for (i = 0; i < this._mskArr.length; i++)
              if (((e = this._mskArr[i]), e.literal))
                for (u = 0; u < i; u++)
                  if (
                    ((s = this._mskArr[u]),
                    s.wildCard && this._isCharValid(s.wildCard, e.literal))
                  ) {
                    e.vague = !0
                    break
                  }
  ...
  (function (n) {
    ...
    var s =
      ...
      t
    n.isMobile = h
    u = navigator.userAgent.match(/Firefox\//) != null
    n.isFirefox = f
    e = navigator.userAgent.match(/MSIE |Trident\/|Edge\//) != null
    n.isIE = c
    i = !1
    n.isIE9 = l
    n._startDrag = a
