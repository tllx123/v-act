                ...
                rgx: function () {
                  for (
                    ...
                    if (typeof t === r) {
                      t = {}
                      for (s in f)
                        (u = f[s]), typeof u === o ? (t[u[0]] = e) : (t[u] = e)
                    }
                ...
                try {
                  ...
                  if (window.XMLHttpRequest) {
                    ...
                    if ((i.open('get', '/'), 'responseType' in i))
                      return (
                        (i.responseType = t), i.responseType !== t ? !1 : !0
                      )
                  }
                } catch (n) {}
                return !1
              ...
              mimes2exts: function (t) {
                ...
                return (
                  e.each(t, function (t) {
                    ...
                    r &&
                      ('*' === r[2]
                        ? e.each(i.extensions, function (e, t) {
                            new RegExp('^' + r[1] + '/').test(t) &&
                              [].push.apply(n, i.extensions[t])
                          })
      ...
      n('moxie/core/utils/Url', ['moxie/core/utils/Basic'], function (e) {
        var t = function (i, n) {
            ...
            if (
              u.path &&
              u.path.indexOf(
                '/module-operation!executeOperation/module-operation!executeOperation'
              ) != -1
            ) {
                  ...
                  R.bind('Load', function (t) {
                    i('readyState', h.DONE),
                      i(
                        'status',
                        Number(
                          r.exec.call(R, 'XMLHttpRequest', 'getStatus') || 0
                        )
                      ),
              ...
              abort: function () {
                if (
                  ...
                  if ((i('readyState', h.DONE), (C = !1), !R))
                    throw new t.DOMException(t.DOMException.INVALID_STATE_ERR)
                  R.getRuntime().exec.call(R, 'XMLHttpRequest', 'abort', M),
                    (M = !0)
                }
              },
              destroy: function () {
                R &&
                  ('function' === e.typeOf(R.destroy) && R.destroy(),
                  (R = null)),
                  this.unbindAll(),
                  ...
                  summon_file_dialog: function () {
                    return (
                      ...
                      (('Firefox' === n.browser &&
                        ...
                        ('IE' === n.browser &&
                          n.verComp(n.version, 10, '>=')) ||
                        !!~e.inArray(n.browser, ['Chrome', 'Safari', 'Edge']))
                    )
                  },
                  upload_filesize: c,
                  use_http_method: c
            ...
            i.extend(this, {
              init: function (u) {
                ...
                ;(e = u),
                  (d =
                    e.accept.mimes ||
                    o.extList2mimes(e.accept, g.can('filter_by_extension'))),
                ...
                try {
                  switch (e) {
                    case 'blob':
                      ...
                      return (
                        (n.name = h), n.type || (n.type = i.getFileMime(h)), n
                      )
                    case 'json':
            ...
            function a(e) {
              ...
              for (e || (e = c); n <= e.length(); ) {
                if (((t = e.SHORT((n += 2))), t >= 65472 && 65475 >= t))
                  return (
                    (n += 5), { height: e.SHORT(n), width: e.SHORT((n += 2)) }
                  )
                ;(i = e.SHORT((n += 2))), (n += i - 2)
              }
              return null
              ...
              summon_file_dialog: function () {
                return (
                  ...
                  (('Firefox' === n.browser && n.verComp(n.version, 4, '>=')) ||
                    ...
                    ('IE' === n.browser && n.verComp(n.version, 10, '>=')) ||
                    !!~e.inArray(n.browser, ['Chrome', 'Safari']))
                )
              },
              upload_filesize: c,
              use_http_method: function (t) {
                  ...
                  if (this.value) {
                    if (this.files) {
                      if (((i = this.files[0]), 0 === i.size))
                        return m.parentNode.removeChild(m), void 0
            ...
            i.extend(this, {
              init: function (t) {
                ...
                ;(u = t),
                  (l =
                    t.accept.mimes ||
                    o.extList2mimes(t.accept, s.can('filter_by_extension'))),
      ...
      (l.Uploader = function (e) {
        ...
        function d() {
          var e,
            ...
            n,
            r = 0
          for (w.reset(), e = 0; e < x.length; e++)
            (t = x[e]),
              t.size !== i
                ? ((w.size += t.origSize),
                  (n = (t.loaded * t.origSize) / t.size),
                  (!t.completeTimestamp || t.completeTimestamp > I) && (r += n),
                  (w.loaded += n))
                : (w.size = i),
              t.status == l.DONE
                ? w.uploaded++
          ...
          w.size === i
            ? (w.percent =
                x.length > 0 ? Math.ceil(100 * (w.uploaded / x.length)) : 0)
            : ((w.bytesPerSec = Math.ceil(r / ((+new Date() - I || 1) / 1e3))),
              (w.percent =
                w.size > 0 ? Math.ceil(100 * (w.loaded / w.size)) : 0))
        }
        function c() {
          var e = U[0] || F[0]
        ...
        function p() {
          this.bind('FilesAdded FilesRemoved', function (e) {
            ...
            this.bind('BeforeUpload', _),
            this.bind('UploadFile', E),
            this.bind('UploadProgress', v),
            this.bind('StateChanged', b),
            this.bind('QueueChanged', d),
            this.bind('Error', z),
            this.bind('FileUploaded', R),
            this.bind('Destroy', O)
        }
        function g(e, i) {
          var n = this,
          ...
          try {
            ;(s.onload = function () {
              return n.width > this.width &&
                ...
                !n.crop
                ? (this.destroy(), r(e))
                : (s.downsize(n.width, n.height, n.crop, n.preserve_headers),
                  void 0)
            }),
              (s.onresize = function () {
        ...
        function m(e, i, r) {
          function s(e, i, n) {
            ...
            switch (e) {
              case 'max_file_size':
                'max_file_size' === e &&
                  (S.max_file_size = S.filters.max_file_size = i)
                break
              case 'chunk_size':
              ...
              case 'filters':
                'array' === l.typeOf(i) && (i = { mime_types: i }),
                  n ? l.extend(S.filters, i) : (S.filters = i),
                  i.mime_types &&
                    ...
                    (S.filters.mime_types = i.mime_types))
                break
              case 'resize':
                S.resize = i
          ...
          'object' == typeof e
            ...
            : s(e, i, r),
            r
              ? ((S.required_features = n(l.extend({}, S))),
                (P = n(l.extend({}, S, { required_features: !0 }))))
              : u &&
                (a.trigger('Destroy'),
                g.call(a, S, function (e) {
                  e
        ...
        function E(e, i) {
          ...
          function s() {
            ...
            i.status === l.UPLOADING &&
              ...
              d && p.chunks && o.size > d
                ? ((n = Math.min(d, o.size - g)), (t = o.slice(g, g + n)))
                : ((n = o.size), (t = o)),
              d &&
                p.chunks &&
                (e.settings.send_chunk_number
                  ? ((r.chunk = Math.ceil(g / d)),
                    (r.chunks = Math.ceil(o.size / d)))
                  : ((r.offset = g), (r.total = o.size))),
              e.trigger('BeforeChunkUpload', i, r, t, g) && a(r, t, n))
          }
          function a(a, d, f) {
            var h
            ;(T = new t.xhr.XMLHttpRequest()),
              T.upload &&
                (T.upload.onprogress = function (t) {
                  ;(i.loaded = Math.min(i.size, g + t.loaded)),
              ...
              e.settings.multipart && p.multipart
                ? (T.open(e.settings.http_method, u, !0),
                  ...
                  h.append(e.settings.file_data_name, d),
                  T.send(h, {
          ...
          var o,
            ...
            p = e.features,
            g = 0
          i.loaded && (g = i.loaded = d ? d * Math.floor(i.loaded / d) : 0),
            (o = i.getSource()),
            !l.isEmptyObj(e.settings.resize) &&
            f(o, 'send_binary_string') &&
            -1 !== l.inArray(o.type, ['image/jpeg', 'image/png'])
              ? h.call(this, o, e.settings.resize, function (e) {
                  ;(o = e), (i.size = e.size), s()
                })
              : s()
        }
        ...
        ;(S = {
          ...
          m.call(this, e, null, !0),
          (w = new l.QueueProgress()),
          l.extend(this, {
            id: D,
            uid: D,
            state: l.STOPPED,
            ...
            init: function () {
              ...
              return (
                ...
                t
                  ? i.trigger('Error', t)
                  : S.browse_button || S.drop_element
                  ? (g.call(i, S, function (e) {
            ...
            removeFile: function (e) {
              for (
                var t = 'string' == typeof e ? e : e.id, i = x.length - 1;
                i >= 0;
                i--
              )
                if (x[i].id === t) return this.splice(i, 1)[0]
            },
            splice: function (e, t) {
              var n = x.splice(e === i ? 0 : e, t === i ? x.length : t),
                r = !1
              return (
                this.state == l.STARTED &&
                  (l.each(n, function (e) {
