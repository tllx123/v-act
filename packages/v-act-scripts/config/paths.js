...
// https://github.com/v3/create-react-app/issues/637
...
// config before eject: we're in ./node_modules/react-v3-scripts/config/
module.exports = {
  dotenv: resolveApp('.env'),
  appPath: resolveApp('.'),
  appBuild: resolveApp(buildPath),
...
// config before publish: we're in ./packages/react-v3-scripts/config/
if (
  !reactScriptsLinked &&
  __dirname.indexOf(path.join('packages', 'react-v3-scripts', 'config')) !== -1
) {
